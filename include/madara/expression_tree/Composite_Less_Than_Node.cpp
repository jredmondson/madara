...
Madara::Expression_Tree::Composite_Less_Than_Node::Composite_Less_Than_Node (
...
Madara::Expression_Tree::Composite_Less_Than_Node::item (void) const
{
...
Madara::Knowledge_Record
Madara::Expression_Tree::Composite_Less_Than_Node::prune (bool & can_change)
{
...
Madara::Knowledge_Record 
Madara::Expression_Tree::Composite_Less_Than_Node::evaluate (
...
// accept a visitor
void 
Madara::Expression_Tree::Composite_Less_Than_Node::accept (Visitor &visitor) const
{
  visitor.visit (*this);
}

...
{
  madara::knowledge::Timed_Event_Thread * caller = 
    static_cast <madara::knowledge::Timed_Event_Thread *> (
      param);
...
madara::knowledge::Timed_Event_Thread::Timed_Event_Thread (
...
int
madara::knowledge::Timed_Event_Thread::svc (void)
{

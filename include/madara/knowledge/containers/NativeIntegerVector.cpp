...
void
madara::knowledge::containers::NativeIntegerVector::modify (void)
{
...
void
madara::knowledge::containers::NativeIntegerVector::modify_ (void)
{
  modify ();
}

std::string
madara::knowledge::containers::NativeIntegerVector::get_debug_info_ (
  void)
{
...
size_t
madara::knowledge::containers::NativeIntegerVector::size (void) const
{
  ContextGuard context_guard (*context_);
  MADARA_GUARD_TYPE guard (mutex_);
...
bool
madara::knowledge::containers::NativeIntegerVector::is_true (void) const
{
  bool result (false);
...
bool
madara::knowledge::containers::NativeIntegerVector::is_false (void) const
{
  return !is_true ();
}
...
bool
madara::knowledge::containers::NativeIntegerVector::is_true_ (void) const
{
  return is_true ();
}

bool
madara::knowledge::containers::NativeIntegerVector::is_false_ (void) const
{
  return is_false ();
}

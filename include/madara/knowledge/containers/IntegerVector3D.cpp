...
void
madara::knowledge::containers::IntegerVector3D::modify (void)
{
  if (context_ && name_ != "")
  {
...
std::string
madara::knowledge::containers::IntegerVector3D::get_debug_info (void)
{
  std::stringstream result;

  result << "IntegerVector3D: ";
...
void
madara::knowledge::containers::IntegerVector3D::modify_ (void)
{
  modify ();
}

std::string
madara::knowledge::containers::IntegerVector3D::get_debug_info_ (void)
{
  return get_debug_info ();
}

madara::knowledge::containers::BaseContainer *
madara::knowledge::containers::IntegerVector3D::clone (void) const
{
  return new IntegerVector3D (*this);
}

void
madara::knowledge::containers::IntegerVector3D::modify (const Indices & index)
{
  if (context_)
  {
    ContextGuard context_guard (*context_);
...
void
madara::knowledge::containers::IntegerVector3D::operator= (
  const IntegerVector3D & rhs)
{
  if (this != &rhs)
  {
...
madara::knowledge::containers::IntegerVector3D::get_size_ref (void)
{
...
void
madara::knowledge::containers::IntegerVector3D::resize (
  const Dimensions & dimensions, bool delete_vars)
{
  if (context_ && name_ != "")
  {
    ...
    madara_logger_log (context_->get_logger (), logger::LOG_MAJOR,
      "IntegerVector3D::resize: resizing to [%d,%d]\n",
    ...
    madara_logger_log (context_->get_logger (), logger::LOG_MINOR,
      "IntegerVector3D::resize: old size is [%d,%d]\n",
    (int)old_size.x, (int)old_size.y);

    if (is_reset)
    {
      madara_logger_log (context_->get_logger (), logger::LOG_MINOR,
        "IntegerVector3D::resize: new size is being reset to size in KB\n");
    ...
    else
    {
      ...
      madara_logger_log (context_->get_logger (), logger::LOG_MAJOR,
        "IntegerVector3D::resize: using dimensions passed in.\n");
    ...
    for (size_t i = 0; i < new_size.x; ++i)
    {
      madara_logger_log (context_->get_logger (), logger::LOG_DETAILED,
        "IntegerVector3D::resize: resizing vector_[%d] to %d.\n",
      ...
      madara_logger_log (context_->get_logger (), logger::LOG_MINOR,
        "IntegerVector3D::resize: creating var_refs from %d->%d.\n",
    ...
    {
      madara_logger_log (context_->get_logger (), logger::LOG_MAJOR,
        "IntegerVector3D::resize: deleting refs: rows: 0->%d.\n",
        (int)old_size.x);
      ...
      for (size_t i = 0; i < old_size.x; ++i)
      {
        ...
        madara_logger_log (context_->get_logger (), logger::LOG_MINOR,
          "IntegerVector3D::resize: deleting refs: %d:%d->%d.\n",
        ...
        for (size_t j = start; j < old_size.y; ++j)
        {
          ...
          for (size_t k = start_k; k < old_size.z; ++k)
          {
            ...
            madara_logger_log (context_->get_logger (), logger::LOG_DETAILED,
              "IntegerVector3D::resize: deleting ref: %s.\n",
              var_name.str ().c_str ());
...
madara::knowledge::containers::IntegerVector3D::Indices
madara::knowledge::containers::IntegerVector3D::size (void) const
{
  Indices cur_size;
...
void
madara::knowledge::containers::IntegerVector3D::set_name (
...
void
madara::knowledge::containers::IntegerVector3D::set_delimiter (
const std::string & delimiter)
{
  delimiter_ = delimiter;
  if (context_)
...
std::string
madara::knowledge::containers::IntegerVector3D::get_delimiter (void)
{
  return delimiter_;
}

void
madara::knowledge::containers::IntegerVector3D::copy_to (
  ...
  if (context_)
  {
    ...
    for (size_t i = 0; i < dimensions.x; ++i)
    {
      ...
      for (size_t j = 0; j < dimensions.y; ++j)
      {
        ...
        for (size_t k = 0; k < dimensions.z; ++k)
        {
          target[i][j][k] = context_->get (
            vector_[i][j][k], keep_local).to_integer ();
        }
      }
    }
  }
...
madara::knowledge::containers::IntegerVector3D::type
madara::knowledge::containers::IntegerVector3D::operator[] (
  const Indices & index) const
{
  ...
  madara_logger_log (context_->get_logger (), logger::LOG_MAJOR,
    "IntegerVector3D::[]: retrieving [%d,%d,%d].\n",
  ...
  if (context_)
  {
    ...
    {
       madara_logger_log (context_->get_logger (), logger::LOG_MINOR,
        "IntegerVector3D::[]: [%d][%d][%d] is within [%d,%d,%d].\n",
        (int)index.x,(int)index.y,(int)index.z,
        (int)vector_.size (),
      ...
      result = context_->get (
        vector_[index.x][index.y][index.z], keep_local).to_integer ();

       madara_logger_log (context_->get_logger (), logger::LOG_MINOR,
        "IntegerVector3D::[]: value is %d.\n",
        (int)result);
    ...
    {
       madara_logger_log (context_->get_logger (), logger::LOG_MINOR,
        "IntegerVector3D::[]: [%d][%d][%d] is not within [%d,%d,%d].\n",
        (int)index.x,(int)index.y,(int)index.z,
        (int)vector_.size (),
        (int)vector_[index.x].size (),
        (int)vector_[index.x][index.y].size ());
...
bool
madara::knowledge::containers::IntegerVector3D::exists (
  const Indices & index) const
{
  bool result (false);
...
int
madara::knowledge::containers::IntegerVector3D::set (
const Indices & index,
type value)
{
  int result = -1;
...
void
madara::knowledge::containers::IntegerVector3D::set_quality (
  const Indices & index,
  uint32_t quality,
...
bool
madara::knowledge::containers::IntegerVector3D::is_true (void) const
{
  bool result (false);

  madara_logger_log (context_->get_logger (), logger::LOG_MAJOR,
    "IntegerVector3D::is_true: Checking for truth\n");
  ...
  if (context_)
  {
    ...
    madara_logger_log (context_->get_logger (), logger::LOG_MINOR,
      "IntegerVector3D::is_true: context was not null. Result changed to %d\n",
      (int)result);
    ...
    for (size_t i = 0; i < vector_.size (); ++i)
    {
      for (size_t j = 0; j < vector_[i].size (); ++i)
      {
        ...
        {
          madara_logger_log (context_->get_logger (), logger::LOG_DETAILED,
            "IntegerVector3D::is_true: checking [%d,%d,%d], is_false of %d. \n",
            (int)i, (int)j, (int)k,
          ...
          {
            madara_logger_log (context_->get_logger (), logger::LOG_MAJOR,
              "IntegerVector3D::is_true: result is false, breaking\n");
  ...
  madara_logger_log (context_->get_logger (), logger::LOG_MAJOR,
    "IntegerVector3D::is_true: final result is %d\n", (int)result);

  return result;
}

bool
madara::knowledge::containers::IntegerVector3D::is_false (void) const
{
  return !is_true ();
}
...
bool
madara::knowledge::containers::IntegerVector3D::is_true_ (void) const
{
  return is_true ();
}

bool
madara::knowledge::containers::IntegerVector3D::is_false_ (void) const
{
  return is_false ();
}

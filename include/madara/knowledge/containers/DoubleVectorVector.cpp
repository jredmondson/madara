#include "DoubleVectorVector.h"
#include "madara/knowledge/ContextGuard.h"

madara::knowledge::containers::DoubleVectorVector::DoubleVectorVector(
...
void madara::knowledge::containers::DoubleVectorVector::modify(void)
{
  if(context_ && name_ != "")
  {
...
std::string madara::knowledge::containers::DoubleVectorVector::get_debug_info(
    void)
{
...
void madara::knowledge::containers::DoubleVectorVector::modify_(void)
{
  modify();
}

std::string madara::knowledge::containers::DoubleVectorVector::get_debug_info_(
    void)
{
...
madara::knowledge::containers::DoubleVectorVector::clone(void) const
{
  return new DoubleVectorVector(*this);
}

void madara::knowledge::containers::DoubleVectorVector::modify(size_t index)
{
...
void madara::knowledge::containers::DoubleVectorVector::operator=(
    const DoubleVectorVector& rhs)
{
  if(this != &rhs)
  {
...
void madara::knowledge::containers::DoubleVectorVector::push_back(
    const type& value)
{
  if(context_ && name_ != "")
  {
...
madara::knowledge::containers::DoubleVectorVector::get_size_ref(void)
{
...
void madara::knowledge::containers::DoubleVectorVector::resize(
    int size, bool delete_vars)
{
  if(context_ && name_ != "")
  {
    ...
    else
    {
      ...
      size_t cur_size = (size_t)context_->get(size_, settings_).to_integer();
...
size_t madara::knowledge::containers::DoubleVectorVector::size(void) const
{
  MADARA_GUARD_TYPE guard(mutex_);
  return vector_.size();
}

void madara::knowledge::containers::DoubleVectorVector::set_name(
...
void madara::knowledge::containers::DoubleVectorVector::set_delimiter(
    const std::string& delimiter)
{
  delimiter_ = delimiter;
  if(context_)
...
std::string madara::knowledge::containers::DoubleVectorVector::get_delimiter(
    void)
{
  return delimiter_;
}

void madara::knowledge::containers::DoubleVectorVector::exchange(
    DoubleVectorVector& other, bool refresh_keys, bool delete_keys)
{
...
void madara::knowledge::containers::DoubleVectorVector::transfer_to(
    DoubleVectorVector& other)
{
  if(context_ && other.context_)
  {
...
void madara::knowledge::containers::DoubleVectorVector::copy_to(
...
madara::knowledge::containers::DoubleVectorVector::type
    madara::knowledge::containers::DoubleVectorVector::operator[](
        size_t index) const
{
  ...
  return result.to_doubles();
}

double madara::knowledge::containers::DoubleVectorVector::operator[](
    Indices index) const
{
  ...
  if(index.x < vector_.size() && context_)
  {
    ...
    MADARA_GUARD_TYPE guard(mutex_);
    result =
        context_->get(vector_[index.x], keep_local).retrieve_index(index.y);
  }
...
madara::knowledge::containers::DoubleVectorVector::to_record(size_t index) const
{
  knowledge::KnowledgeRecord result;
  KnowledgeUpdateSettings keep_local(true);
...
bool madara::knowledge::containers::DoubleVectorVector::exists(
    size_t index) const
{
  bool result(false);
...
int madara::knowledge::containers::DoubleVectorVector::set(
...
void madara::knowledge::containers::DoubleVectorVector::set_quality(
...
bool madara::knowledge::containers::DoubleVectorVector::is_true(void) const
{
  bool result(false);

  madara_logger_log(context_->get_logger(), logger::LOG_MAJOR,
      "DoubleVectorVector::is_true: Checking for truth\n");
  ...
  if(context_)
  {
    ...
    madara_logger_log(context_->get_logger(), logger::LOG_MINOR,
        "DoubleVectorVector::is_true: context was not null. Result changed to "
        "%d\n",
        (int)result);
    ...
    for(size_t index = 0; index < vector_.size(); ++index)
    {
      madara_logger_log(context_->get_logger(), logger::LOG_DETAILED,
          "DoubleVectorVector::is_true: checking index %d, is_false of %d. \n",
          (int)result, (int)context_->get(vector_[index]).is_false());

      if(context_->get(vector_[index]).is_false())
      {
        madara_logger_log(context_->get_logger(), logger::LOG_MAJOR,
            "DoubleVectorVector::is_true: result is false, breaking\n");
  ...
  madara_logger_log(context_->get_logger(), logger::LOG_MAJOR,
      "DoubleVectorVector::is_true: final result is %d\n", (int)result);

  return result;
}

bool madara::knowledge::containers::DoubleVectorVector::is_false(void) const
{
  return !is_true();
}

bool madara::knowledge::containers::DoubleVectorVector::is_true_(void) const
{
  return is_true();
}

bool madara::knowledge::containers::DoubleVectorVector::is_false_(void) const
{
  return is_false();
}

...
void
madara::knowledge::containers::DoubleVectorVector::modify (void)
{
  if (context_ && name_ != "")
  {
...
std::string
madara::knowledge::containers::DoubleVectorVector::get_debug_info (void)
{
...
void
madara::knowledge::containers::DoubleVectorVector::modify_ (void)
{
  modify ();
}

std::string
madara::knowledge::containers::DoubleVectorVector::get_debug_info_ (void)
{
...
void
madara::knowledge::containers::DoubleVectorVector::modify (size_t index)
{
...
void
madara::knowledge::containers::DoubleVectorVector::push_back (const type & value)
{
  if (context_ && name_ != "")
  {
    ContextGuard context_guard (*context_);
...
void
madara::knowledge::containers::DoubleVectorVector::resize (
...
size_t
madara::knowledge::containers::DoubleVectorVector::size (void) const
{
  MADARA_GUARD_TYPE guard (mutex_);
  return vector_.size ();
}
...
void
madara::knowledge::containers::DoubleVectorVector::set_name (
...
void
madara::knowledge::containers::DoubleVectorVector::set_delimiter (
const std::string & delimiter)
{
  delimiter_ = delimiter;
  if (context_)
...
std::string
madara::knowledge::containers::DoubleVectorVector::get_delimiter (void)
{
  return delimiter_;
}

void
madara::knowledge::containers::DoubleVectorVector::exchange (
...
void
madara::knowledge::containers::DoubleVectorVector::transfer_to (
...
void
madara::knowledge::containers::DoubleVectorVector::copy_to (
...
madara::knowledge::containers::DoubleVectorVector::to_record (
  size_t index) const
{
  knowledge::KnowledgeRecord result;
  KnowledgeUpdateSettings keep_local (true);
...
bool
madara::knowledge::containers::DoubleVectorVector::exists (
  size_t index) const
{
  bool result (false);
...
int
madara::knowledge::containers::DoubleVectorVector::set (
size_t index,
type value)
{
  int result = -1;
...
void
madara::knowledge::containers::DoubleVectorVector::set_quality (
  size_t index,
  uint32_t quality,
...
bool
madara::knowledge::containers::DoubleVectorVector::is_true (void) const
{
  bool result (false);
  ...
  if (context_)
  {
    ...
    madara_logger_log (context_->get_logger (), logger::LOG_MINOR,
      "DoubleVectorVector::is_true: context was not null. Result changed to %d\n",
      (int)result);
...
bool
madara::knowledge::containers::DoubleVectorVector::is_false (void) const
{
  return !is_true ();
}
...
bool
madara::knowledge::containers::DoubleVectorVector::is_true_ (void) const
{
  return is_true ();
}

bool
madara::knowledge::containers::DoubleVectorVector::is_false_ (void) const
{
  return is_false ();
}

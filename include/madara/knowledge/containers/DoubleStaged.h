...
#ifndef _MADARA_KNOWLEDGE_CONTAINERS_DOUBLESTAGED_H_
#define _MADARA_KNOWLEDGE_CONTAINERS_DOUBLESTAGED_H_
 ...
 *
 * This file contains a C++ object that manages interactions for a double
...
/**
 * @class DoubleStaged
 * @brief Stages an integer value to and from the knowledge base. This
...
public:
   ...
   * @param  settings   settings for updating knowledge
   **/
  DoubleStaged(const std::string& name, KnowledgeBase& knowledge,
      const KnowledgeUpdateSettings& settings = KnowledgeUpdateSettings());
   ...
   * @param  settings  settings for updating knowledge
   **/
  DoubleStaged(const std::string& name, Variables& knowledge,
      const KnowledgeUpdateSettings& settings = KnowledgeUpdateSettings());
   ...
   * @param  settings   settings for updating knowledge
   **/
  DoubleStaged(const std::string& name, KnowledgeBase& knowledge, type value,
      const KnowledgeUpdateSettings& settings = KnowledgeUpdateSettings());
   ...
   * @param  settings   settings for updating knowledge
   **/
  DoubleStaged(const std::string& name, Variables& knowledge, type value,
      const KnowledgeUpdateSettings& settings = KnowledgeUpdateSettings());

  /**
   * Copy constructor
   **/
  DoubleStaged(const DoubleStaged& rhs);

  /**
   * Destructor
   **/
  virtual ~DoubleStaged();

  /**
   * Mark the value as modified. The DoubleStaged retains the same value
   ...
   **/
  void exchange(DoubleStaged& other);
...
#include "DoubleStaged.inl"

#endif  // _MADARA_KNOWLEDGE_CONTAINERS_DOUBLESTAGED_H_

...
void
madara::knowledge::containers::DoubleVector2D::modify (void)
{
  if (context_ && name_ != "")
  {
...
std::string
madara::knowledge::containers::DoubleVector2D::get_debug_info (void)
{
...
void
madara::knowledge::containers::DoubleVector2D::modify_ (void)
{
  modify ();
}

std::string
madara::knowledge::containers::DoubleVector2D::get_debug_info_ (void)
{
...
void
madara::knowledge::containers::DoubleVector2D::modify (const Indices & index)
{
  if (context_)
  {
    ContextGuard context_guard (*context_);
...
void
madara::knowledge::containers::DoubleVector2D::resize (
...
void
madara::knowledge::containers::DoubleVector2D::set_name (
...
void
madara::knowledge::containers::DoubleVector2D::set_delimiter (
const std::string & delimiter)
{
  delimiter_ = delimiter;
  if (context_)
...
std::string
madara::knowledge::containers::DoubleVector2D::get_delimiter (void)
{
  return delimiter_;
}
  ...
  const Indices & index) const
{
  ...
  if (context_)
  {
    ...
    {
      result = context_->get (
        vector_[index.x][index.y], keep_local).to_double ();
    }
  }
...
bool
madara::knowledge::containers::DoubleVector2D::exists (
  const Indices & index) const
{
  bool result (false);
...
void
madara::knowledge::containers::DoubleVector2D::set_quality (
  const Indices & index,
  uint32_t quality,
...
bool
madara::knowledge::containers::DoubleVector2D::is_true (void) const
{
  bool result (false);
...
bool
madara::knowledge::containers::DoubleVector2D::is_false (void) const
{
  return !is_true ();
}
...
bool
madara::knowledge::containers::DoubleVector2D::is_true_ (void) const
{
  return is_true ();
}

bool
madara::knowledge::containers::DoubleVector2D::is_false_ (void) const
{
  return is_false ();
}

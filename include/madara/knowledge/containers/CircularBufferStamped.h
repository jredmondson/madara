...
#ifndef _MADARA_KNOWLEDGE_CONTAINERS_CIRCULARBUFFERSTAMPED_H_
#define _MADARA_KNOWLEDGE_CONTAINERS_CIRCULARBUFFERSTAMPED_H_
...
/**
 * @file CircularBufferStamped.h
 * @author James Edmondson <jedmondson@gmail.com>
 *
 * This file contains a high performance thread-safe circular buffer
...
namespace madara
{
  namespace knowledge
  {
    ...
    {
      /**
       * @class CircularBufferStamped
       * @brief This container stores a thread-safe circular buffer with O(1)
       * access times and an insertion timestamp for each add
       */
      class MADARA_EXPORT CircularBufferStamped
      {
      public:
        /**
         * Default constructor
         **/
        CircularBufferStamped (const KnowledgeUpdateSettings & settings =
         ...
         **/
        CircularBufferStamped (const std::string & name,
         ...
         * @param  name       name of the integer in the knowledge base
         * @param  knowledge  the knowledge base that will contain the vector
         * @param  size       the size of the CircularBufferStamped
         * @param  settings   settings for evaluating the vector
         * @throw exceptions::NameException  bad name ("")
         **/
        CircularBufferStamped (const std::string & name,
         ...
         * Copy constructor
         **/
        CircularBufferStamped (const CircularBufferStamped & rhs);

        /**
         * Destructor
         **/
        virtual ~CircularBufferStamped () = default;
        
        /**
         * Assignment operator
         * @param  rhs    value to copy
         **/
        void operator= (const CircularBufferStamped & rhs);
         ...
         **/
        bool operator== (const CircularBufferStamped & value) const;
        ...
        /**
         * Adds a record to the end of the CircularBufferStamped
        ...
        /**
         * Adds a value to the end of the CircularBufferStamped
        ...
        /**
         * Adds a list of records to the end of the CircularBufferStamped
        ...
        /**
         * Adds a list of user values to the end of the CircularBufferStamped
         ...
         * @return  the record at the position in the CircularBufferStamped
         ...
         * @param  position  the relative position of the requested record
         *                   from the latest added record. Can be negative
         * @param  value     the value at the position in the CircularBufferStamped
         * @throw exceptions::ContextException if name or context haven't
         *                      been set appropriately
         * @throw exceptions::IndexException  if index is out of range/invalid
         **/
         ...
         *                   from the latest added record. Can be negative
         * @param  count   the maximum number of records to return
         * @return  the record at the position in the CircularBufferStampedConsumer
         * @throw exceptions::ContextException if name or context haven't
         *                      been set appropriately
         * @throw exceptions::IndexException  if index is out of range/invalid
         **/
         ...
         *                   from the latest added record. Can be negative
         * @param  count   the maximum number of records to return
         * @param  values  the values at the position in the CircularBufferStampedConsumer
         * @throw exceptions::ContextException if name or context haven't
         *                      been set appropriately
         * @throw exceptions::IndexException  if index is out of range/invalid
         **/
        ...
        /**
         * Clears the CircularBufferStamped
         * @throw exceptions::ContextException  if name or context haven't
         *                      been set appropriately
         **/
        void clear (void);
        ...
        /**
         * Returns the number of records in the CircularBufferStamped
         * @return the number of records in the CircularBufferStamped
         * @throw exceptions::ContextException  if name or context haven't
         *                      been set appropriately
         **/
        ...
        /**
         * Returns the maximum size of the CircularBufferStamped
         * @return the size of the CircularBufferStamped
         **/
        ...
        /**
         * Resizes the CircularBufferStamped
         * @param  size      the size of the CircularBufferStamped. -1 means use the size that
...
#include "CircularBufferStamped.inl"

#endif // _MADARA_KNOWLEDGE_CONTAINERS_CIRCULARBUFFERSTAMPED_H_

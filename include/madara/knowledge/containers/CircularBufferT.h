  ...
  namespace knowledge
  {
    namespace containers
    {
      ...
      public:
         ...
         * Default constructor
         **/
        CircularBufferT (const KnowledgeUpdateSettings & settings =
         ...
         **/
        CircularBufferT (const std::string & name,
         ...
         * @param  size      the size of the CircularBufferT. -1 means use the size that

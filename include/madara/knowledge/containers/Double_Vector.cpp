...
madara::knowledge::containers::Double_Vector::Double_Vector (
...
void
madara::knowledge::containers::Double_Vector::modify (void)
{
  if (context_ && name_ != "")
  {
...
std::string
madara::knowledge::containers::Double_Vector::get_debug_info (void)
{
...
void
madara::knowledge::containers::Double_Vector::modify_ (void)
{
  modify ();
}

std::string
madara::knowledge::containers::Double_Vector::get_debug_info_ (void)
{
  return get_debug_info ();
}

madara::knowledge::containers::Base_Container *
madara::knowledge::containers::Double_Vector::clone (void) const
{
  return new Double_Vector (*this);
}

void
madara::knowledge::containers::Double_Vector::modify (size_t index)
{
...
void
madara::knowledge::containers::Double_Vector::operator= (
  const Double_Vector & rhs)
{
  if (this != &rhs)
  {
...
void
madara::knowledge::containers::Double_Vector::push_back (type value)
{
  if (context_ && name_ != "")
  {
    Context_Guard context_guard (*context_);
...
madara::knowledge::containers::Double_Vector::get_size_ref (void)
{
...
void
madara::knowledge::containers::Double_Vector::resize (
...
size_t
madara::knowledge::containers::Double_Vector::size (void) const
{
  Guard guard (mutex_);
  return vector_.size ();
}
...
void
madara::knowledge::containers::Double_Vector::set_name (
...
void
madara::knowledge::containers::Double_Vector::set_delimiter (
const std::string & delimiter)
{
  delimiter_ = delimiter;
  if (context_)
...
std::string
madara::knowledge::containers::Double_Vector::get_delimiter (void)
{
  return delimiter_;
}

void
madara::knowledge::containers::Double_Vector::exchange (
...
void
madara::knowledge::containers::Double_Vector::transfer_to (
  Double_Vector & other)
{
  if (context_ && other.context_)
  {
...
void
madara::knowledge::containers::Double_Vector::copy_to (
...
madara::knowledge::containers::Double_Vector::type
madara::knowledge::containers::Double_Vector::operator[] (
  size_t index) const
{
...
madara::knowledge::containers::Double_Vector::to_record (
  size_t index) const
{
  Knowledge_Record result;
  Knowledge_Update_Settings keep_local (true);
...
madara::Knowledge_Record
madara::knowledge::containers::Double_Vector::to_record (void) const
{
  Knowledge_Record result;
  Knowledge_Update_Settings keep_local (true);
...
bool
madara::knowledge::containers::Double_Vector::exists (
  size_t index) const
{
  bool result (false);
...
int
madara::knowledge::containers::Double_Vector::set (
size_t index,
type value)
{
  int result = -1;
...
void
madara::knowledge::containers::Double_Vector::set_quality (
  size_t index,
  uint32_t quality,
...
bool
madara::knowledge::containers::Double_Vector::is_true (void) const
{
  bool result (false);
...
bool
madara::knowledge::containers::Double_Vector::is_false (void) const
{
  return !is_true ();
}
...
bool
madara::knowledge::containers::Double_Vector::is_true_ (void) const
{
  return is_true ();
}

bool
madara::knowledge::containers::Double_Vector::is_false_ (void) const
{
  return is_false ();
}

...
void madara::knowledge::containers::DoubleVector::modify(void)
{
  if(context_ && name_ != "")
  {
...
std::string madara::knowledge::containers::DoubleVector::get_debug_info(void)
{
...
void madara::knowledge::containers::DoubleVector::modify_(void)
{
  modify();
}

std::string madara::knowledge::containers::DoubleVector::get_debug_info_(void)
{
...
void madara::knowledge::containers::DoubleVector::modify(size_t index)
{
...
void madara::knowledge::containers::DoubleVector::operator=(
    const DoubleVector& rhs)
{
  if(this != &rhs)
  {
...
void madara::knowledge::containers::DoubleVector::push_back(type value)
{
  if(context_ && name_ != "")
  {
    ContextGuard context_guard(*context_);
...
void madara::knowledge::containers::DoubleVector::resize(
...
size_t madara::knowledge::containers::DoubleVector::size(void) const
{
  MADARA_GUARD_TYPE guard(mutex_);
  return vector_.size();
}

void madara::knowledge::containers::DoubleVector::set_name(
...
void madara::knowledge::containers::DoubleVector::set_delimiter(
    const std::string& delimiter)
{
  delimiter_ = delimiter;
  if(context_)
...
std::string madara::knowledge::containers::DoubleVector::get_delimiter(void)
{
  return delimiter_;
}

void madara::knowledge::containers::DoubleVector::exchange(
...
void madara::knowledge::containers::DoubleVector::transfer_to(
    DoubleVector& other)
{
  if(context_ && other.context_)
  {
...
void madara::knowledge::containers::DoubleVector::copy_to(
...
madara::knowledge::containers::DoubleVector::type
    madara::knowledge::containers::DoubleVector::operator[](size_t index) const
{
...
madara::knowledge::containers::DoubleVector::to_record(size_t index) const
{
  knowledge::KnowledgeRecord result;
  KnowledgeUpdateSettings keep_local(true);
...
madara::knowledge::containers::DoubleVector::to_record(void) const
{
  ...
  if(vector_.size() > 0 && context_)
  {
    ...
    {
      result.set_index(i, context_->get(vector_[i], keep_local).to_double());
    }
  }
...
bool madara::knowledge::containers::DoubleVector::exists(size_t index) const
{
  bool result(false);
...
int madara::knowledge::containers::DoubleVector::set(size_t index, type value)
{
  int result = -1;
...
int madara::knowledge::containers::DoubleVector::set(
...
void madara::knowledge::containers::DoubleVector::set_quality(
...
bool madara::knowledge::containers::DoubleVector::is_true(void) const
{
  bool result(false);
...
bool madara::knowledge::containers::DoubleVector::is_false(void) const
{
  return !is_true();
}

bool madara::knowledge::containers::DoubleVector::is_true_(void) const
{
  return is_true();
}

bool madara::knowledge::containers::DoubleVector::is_false_(void) const
{
  return is_false();
}

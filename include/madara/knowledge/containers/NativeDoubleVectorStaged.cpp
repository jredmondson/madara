...
madara::knowledge::containers::NativeDoubleVectorStaged::
    NativeDoubleVectorStaged(const std::string& name, KnowledgeBase& knowledge,
...
bool madara::knowledge::containers::NativeDoubleVectorStaged::is_false_(
    void) const
{
  return is_false();
}

bool madara::knowledge::containers::NativeDoubleVectorStaged::is_true_(
    void) const
{
  return is_true();
}

void madara::knowledge::containers::NativeDoubleVectorStaged::modify_(void)
{
  modify();
}

...
std::string madara::knowledge::containers::IntegerVectorVector::get_debug_info(
    void)
{
...
void madara::knowledge::containers::IntegerVectorVector::modify_(void)
{
  modify();
}

std::string madara::knowledge::containers::IntegerVectorVector::get_debug_info_(
    void)
{
...
void madara::knowledge::containers::IntegerVectorVector::operator=(
    const IntegerVectorVector& rhs)
{
  if(this != &rhs)
  {
...
void madara::knowledge::containers::IntegerVectorVector::push_back(
    const type& value)
{
  if(context_ && name_ != "")
  {
...
void madara::knowledge::containers::IntegerVectorVector::resize(
...
void madara::knowledge::containers::IntegerVectorVector::set_name(
...
void madara::knowledge::containers::IntegerVectorVector::set_delimiter(
    const std::string& delimiter)
{
  delimiter_ = delimiter;
  if(context_)
...
std::string madara::knowledge::containers::IntegerVectorVector::get_delimiter(
    void)
{
  return delimiter_;
}

void madara::knowledge::containers::IntegerVectorVector::exchange(
...
void madara::knowledge::containers::IntegerVectorVector::transfer_to(
...
void madara::knowledge::containers::IntegerVectorVector::copy_to(
...
int64_t madara::knowledge::containers::IntegerVectorVector::operator[](
    Indices index) const
{
...
bool madara::knowledge::containers::IntegerVectorVector::exists(
    size_t index) const
{
  bool result(false);
...
int madara::knowledge::containers::IntegerVectorVector::set(
...
void madara::knowledge::containers::IntegerVectorVector::set_quality(
...
bool madara::knowledge::containers::IntegerVectorVector::is_true(void) const
{
  ...
  if(context_)
  {
    ...
    madara_logger_log(context_->get_logger(), logger::LOG_MINOR,
        "IntegerVectorVector::is_true: context was not null. Result changed to "
        "%d\n",
        (int)result);
...
bool madara::knowledge::containers::IntegerVectorVector::is_true_(void) const
{
  return is_true();
}

bool madara::knowledge::containers::IntegerVectorVector::is_false_(void) const
{
  return is_false();
}

...
madara::knowledge::containers::IntegerVectorVector::IntegerVectorVector (
...
void
madara::knowledge::containers::IntegerVectorVector::modify (void)
{
  if (context_ && name_ != "")
  {
...
std::string
madara::knowledge::containers::IntegerVectorVector::get_debug_info (void)
{
...
void
madara::knowledge::containers::IntegerVectorVector::modify_ (void)
{
  modify ();
}

std::string
madara::knowledge::containers::IntegerVectorVector::get_debug_info_ (void)
{
  return get_debug_info ();
}

madara::knowledge::containers::BaseContainer *
madara::knowledge::containers::IntegerVectorVector::clone (void) const
{
  return new IntegerVectorVector (*this);
}

void
madara::knowledge::containers::IntegerVectorVector::modify (size_t index)
{
...
void
madara::knowledge::containers::IntegerVectorVector::operator= (
  const IntegerVectorVector & rhs)
{
  if (this != &rhs)
  {
...
void
madara::knowledge::containers::IntegerVectorVector::push_back (const type & value)
{
  if (context_ && name_ != "")
  {
    ContextGuard context_guard (*context_);
...
madara::knowledge::containers::IntegerVectorVector::get_size_ref (void)
{
...
void
madara::knowledge::containers::IntegerVectorVector::resize (
...
size_t
madara::knowledge::containers::IntegerVectorVector::size (void) const
{
  MADARA_GUARD_TYPE guard (mutex_);
  return vector_.size ();
}
...
void
madara::knowledge::containers::IntegerVectorVector::set_name (
...
void
madara::knowledge::containers::IntegerVectorVector::set_delimiter (
const std::string & delimiter)
{
  delimiter_ = delimiter;
  if (context_)
...
std::string
madara::knowledge::containers::IntegerVectorVector::get_delimiter (void)
{
  return delimiter_;
}

void
madara::knowledge::containers::IntegerVectorVector::exchange (
  IntegerVectorVector & other, bool refresh_keys, bool delete_keys)
{
...
void
madara::knowledge::containers::IntegerVectorVector::transfer_to (
  IntegerVectorVector & other)
{
  if (context_ && other.context_)
  {
    std::lock(*context_, *other.context_, mutex_, other.mutex_);
...
void
madara::knowledge::containers::IntegerVectorVector::copy_to (
...
void
madara::knowledge::containers::IntegerVectorVector::copy_to (
  std::vector <IntegerVectorVector::type > & target) const
{
  if (context_)
  {
    ContextGuard context_guard (*context_);
...
madara::knowledge::containers::IntegerVectorVector::type
madara::knowledge::containers::IntegerVectorVector::operator[] (
  size_t index) const
{
...
madara::knowledge::containers::IntegerVectorVector::to_record (
  size_t index) const
{
  knowledge::KnowledgeRecord result;
  KnowledgeUpdateSettings keep_local (true);
...
bool
madara::knowledge::containers::IntegerVectorVector::exists (
  size_t index) const
{
  bool result (false);
...
int
madara::knowledge::containers::IntegerVectorVector::set (
size_t index,
type value)
{
  int result = -1;
...
void
madara::knowledge::containers::IntegerVectorVector::set_quality (
  size_t index,
  uint32_t quality,
...
bool
madara::knowledge::containers::IntegerVectorVector::is_true (void) const
{
  bool result (false);

  madara_logger_log (context_->get_logger (), logger::LOG_MAJOR,
    "IntegerVectorVector::is_true: Checking for truth\n");
  ...
  if (context_)
  {
    ...
    madara_logger_log (context_->get_logger (), logger::LOG_MINOR,
      "IntegerVectorVector::is_true: context was not null. Result changed to %d\n",
      (int)result);
    ...
    for (size_t index = 0; index < vector_.size (); ++index)
    {
      ...
      madara_logger_log (context_->get_logger (), logger::LOG_DETAILED,
        "IntegerVectorVector::is_true: checking index %d, is_false of %d. \n",
        (int)result, (int)context_->get (vector_[index]).is_false ());

      if (context_->get (vector_[index]).is_false ())
      {
        madara_logger_log (context_->get_logger (), logger::LOG_MAJOR,
          "IntegerVectorVector::is_true: result is false, breaking\n");
  ...
  madara_logger_log (context_->get_logger (), logger::LOG_MAJOR,
    "IntegerVectorVector::is_true: final result is %d\n", (int)result);

  return result;
}

bool
madara::knowledge::containers::IntegerVectorVector::is_false (void) const
{
  return !is_true ();
}
...
bool
madara::knowledge::containers::IntegerVectorVector::is_true_ (void) const
{
  return is_true ();
}

bool
madara::knowledge::containers::IntegerVectorVector::is_false_ (void) const
{
  return is_false ();
}

...
#ifndef _MADARA_CONTAINERS_INTEGER_VECTOR3D_H_
#define _MADARA_CONTAINERS_INTEGER_VECTOR3D_H_
...
/**
 * @file IntegerVector3D.h
 * @author James Edmondson <jedmondson@gmail.com>
 *
 * This file contains a C++ object that manages interactions for a
 * 3D array of integers that can have lazy updates on each cell.
 **/
  ...
  namespace knowledge
  {
    namespace containers
    {
      ...
      public:
         ...
         **/
        IntegerVector3D (const KnowledgeUpdateSettings & settings =
         ...
         * @param  dimensions size of the vector. {0,0,0} to check for size.
         * @param  knowledge  the knowledge base that will contain the vector
         * @param  delete_vars delete indices outside of the specified range
         * @param  settings   settings for evaluating the vector
         * @param  delimiter  the delimiter for variables in the vector
         **/
        IntegerVector3D (const std::string & name, 
        ...
        **/
         ...
         * @param dimensions size of the new vector ({0,0,0} to not change size)
         **/
        void set_name (const std::string & var_name,
          KnowledgeBase & knowledge, const Dimensions & dimensions = {0,0,0});
         ...
         **/
        void set_name (const std::string & var_name,
          Variables & knowledge, const Dimensions & dimensions = {0,0,0});
...
#endif // _MADARA_CONTAINERS_INTEGER_VECTOR3D_H_

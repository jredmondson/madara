...
{
public:
  /// Allow the Queue, CircularBuffer, and CircularBufferConsumer classes
   ...
   **/
  Vector(const KnowledgeUpdateSettings& settings = KnowledgeUpdateSettings(),
   ...
   * @param  delimiter  the delimiter for variables in the vector
   **/
  Vector(const std::string& name, KnowledgeBase& knowledge, int size = -1,
   ...
   * @param  delimiter  the delimiter for variables in the vector
   **/
  Vector(const std::string& name, Variables& knowledge, int size = -1,
      bool delete_vars = true,
      const KnowledgeUpdateSettings& settings = KnowledgeUpdateSettings(),
      const std::string& delimiter = ".");
   ...
   **/
  void exchange(
      Vector& other, bool refresh_keys = true, bool delete_keys = true);
   ...
   **/
  void set_name(
      const std::string& var_name, KnowledgeBase& knowledge, int size = -1);
   ...
   **/
  void set_name(
      const std::string& var_name, Variables& knowledge, int size = -1);
   ...
   **/
  void set_name(
      const std::string& var_name, ThreadSafeContext& knowledge, int size = -1);
   ...
   **/
  int set(size_t index, madara::knowledge::KnowledgeRecord::Integer value =
   ...
   *                        -2 if quality isn't high enough
   **/
  int set_index(size_t index, size_t sub_index,

...
inline void
madara::knowledge::containers::IntegerStaged::modify (void)
{
...
inline std::string
madara::knowledge::containers::IntegerStaged::get_debug_info (void)
{
...
inline void
madara::knowledge::containers::IntegerStaged::operator= (const IntegerStaged & rhs)
{
  if (this != &rhs)
  {
...
inline void
madara::knowledge::containers::IntegerStaged::set_name (
...
inline bool
madara::knowledge::containers::IntegerStaged::operator== (type value) const
{
  return value_ == value;
}
...
inline bool
madara::knowledge::containers::IntegerStaged::operator== (
...
inline bool
madara::knowledge::containers::IntegerStaged::exists (void) const
{
  bool result (false);
...
inline bool
madara::knowledge::containers::IntegerStaged::is_true (void) const
{
  return value_ != 0;
}

inline bool
madara::knowledge::containers::IntegerStaged::is_false (void) const
{
  return value_ == 0;
}
...
inline double
madara::knowledge::containers::IntegerStaged::to_double (void) const
{
  return (double)value_;
}
   
inline std::string
madara::knowledge::containers::IntegerStaged::to_string (void) const
{
...
inline void
madara::knowledge::containers::IntegerStaged::set_quality (
  uint32_t quality,
...
inline void
madara::knowledge::containers::IntegerStaged::read (void)
{
  has_changed_ = false;
  value_ = context_->get (variable_).to_integer ();
}
...
inline void
madara::knowledge::containers::IntegerStaged::write (void)
{
  if (has_changed_)

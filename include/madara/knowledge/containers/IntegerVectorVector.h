...
#ifndef _MADARA_CONTAINERS_INTEGER_VECTOR_VECTOR_H_
#define _MADARA_CONTAINERS_INTEGER_VECTOR_VECTOR_H_
...
public:
   ...
   * @param  delimiter  the delimiter for variables in the vector
   **/
  IntegerVectorVector(const std::string& name, KnowledgeBase& knowledge,
      int size = -1, bool delete_vars = true,
      const KnowledgeUpdateSettings& settings = KnowledgeUpdateSettings(),
      const std::string& delimiter = ".");
   ...
   * @param  delimiter  the delimiter for variables in the vector
   **/
  IntegerVectorVector(const std::string& name, Variables& knowledge,
      int size = -1, bool delete_vars = true,
      const KnowledgeUpdateSettings& settings = KnowledgeUpdateSettings(),
      const std::string& delimiter = ".");
   ...
   **/
  void exchange(IntegerVectorVector& other, bool refresh_keys = true,
...
#endif  // _MADARA_CONTAINERS_INTEGER_VECTOR_VECTOR_H_

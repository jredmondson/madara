...
#ifndef _MADARA_CONTAINERS_DOUBLE_VECTOR3D_H_
#define _MADARA_CONTAINERS_DOUBLE_VECTOR3D_H_
  ...
  namespace knowledge
  {
    namespace containers
    {
      ...
      public:
         ...
         **/
        DoubleVector3D (const KnowledgeUpdateSettings & settings =
         ...
         * @param  delimiter  the delimiter for variables in the vector
         **/
        DoubleVector3D (const std::string & name, 
...
#endif // _MADARA_CONTAINERS_DOUBLE_VECTOR3D_H_

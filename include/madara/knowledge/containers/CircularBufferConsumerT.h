...
public:
   ...
   **/
  CircularBufferConsumerT(const std::string& name, KnowledgeBase& knowledge);
   ...
   * @throw exceptions::NameException  bad name ("")
   **/
  CircularBufferConsumerT(const std::string& name, Variables& knowledge);

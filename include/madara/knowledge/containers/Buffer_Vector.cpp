...
madara::knowledge::containers::Buffer_Vector::Buffer_Vector (
...
madara::knowledge::containers::Buffer_Vector::Buffer_Vector (const Buffer_Vector & rhs)
...
void
madara::knowledge::containers::Buffer_Vector::modify (void)
{
  if (context_ && name_ != "")
  {
...
std::string
madara::knowledge::containers::Buffer_Vector::get_debug_info (void)
{
...
void
madara::knowledge::containers::Buffer_Vector::modify_ (void)
{
  modify ();
}

std::string
madara::knowledge::containers::Buffer_Vector::get_debug_info_ (void)
{
  return get_debug_info ();
}

madara::knowledge::containers::Base_Container *
madara::knowledge::containers::Buffer_Vector::clone (void) const
{
  return new Buffer_Vector (*this);
}

void
madara::knowledge::containers::Buffer_Vector::modify (size_t index)
{
...
void
madara::knowledge::containers::Buffer_Vector::operator= (
...
void
madara::knowledge::containers::Buffer_Vector::push_back (
...
madara::knowledge::containers::Buffer_Vector::get_size_ref (void)
{
...
void
madara::knowledge::containers::Buffer_Vector::resize (
...
size_t
madara::knowledge::containers::Buffer_Vector::size (void) const
{
  Guard guard (mutex_);
  return vector_.size ();
}
...
void
madara::knowledge::containers::Buffer_Vector::set_name (
...
void
madara::knowledge::containers::Buffer_Vector::set_delimiter (
const std::string & delimiter)
{
  delimiter_ = delimiter;
  if (context_)
...
std::string
madara::knowledge::containers::Buffer_Vector::get_delimiter (void)
{
  return delimiter_;
}

void
madara::knowledge::containers::Buffer_Vector::exchange (
...
void
madara::knowledge::containers::Buffer_Vector::transfer_to (Buffer_Vector & other)
{
  if (context_ && other.context_)
  {
    Context_Guard context_guard (*context_);
...
void
madara::knowledge::containers::Buffer_Vector::copy_to (
...
madara::Knowledge_Record
madara::knowledge::containers::Buffer_Vector::to_record (
  size_t index) const
{
...
bool
madara::knowledge::containers::Buffer_Vector::exists (
  size_t index) const
{
  bool result (false);
...
int
madara::knowledge::containers::Buffer_Vector::read_file (
  size_t index,
...
int
madara::knowledge::containers::Buffer_Vector::set_file (
  size_t index,
  const unsigned char * value, size_t size)
{
  int result = -1;
...
int
madara::knowledge::containers::Buffer_Vector::set (
...
int
madara::knowledge::containers::Buffer_Vector::set_jpeg (
  size_t index,
  const unsigned char * value, size_t size)
{
  int result = -1;
...
void
madara::knowledge::containers::Buffer_Vector::set_quality (
  size_t index,
  uint32_t quality,
...
bool
madara::knowledge::containers::Buffer_Vector::is_true (void) const
{
  bool result (false);

  madara_logger_log (context_->get_logger (), logger::LOG_MAJOR,
    "Buffer_Vector::is_true: Checking for truth\n");
  ...
  if (context_)
  {
    ...
    madara_logger_log (context_->get_logger (), logger::LOG_MINOR,
      "Buffer_Vector::is_true: context was not null. Result changed to %d\n",
      (int)result);
    ...
    for (size_t index = 0; index < vector_.size (); ++index)
    {
      ...
      madara_logger_log (context_->get_logger (), logger::LOG_DETAILED,
        "Buffer_Vector::is_true: checking index %d, is_false of %d. \n",
        (int)result, (int)context_->get (vector_[index]).is_false ());

      if (context_->get (vector_[index]).is_false ())
      {
        madara_logger_log (context_->get_logger (), logger::LOG_MAJOR,
          "Buffer_Vector::is_true: result is false, breaking\n");
  ...
  madara_logger_log (context_->get_logger (), logger::LOG_MAJOR,
    "Buffer_Vector::is_true: final result is %d\n", (int)result);

  return result;
}

bool
madara::knowledge::containers::Buffer_Vector::is_false (void) const
{
  return !is_true ();
}
...
bool
madara::knowledge::containers::Buffer_Vector::is_true_ (void) const
{
  return is_true ();
}

bool
madara::knowledge::containers::Buffer_Vector::is_false_ (void) const
{
  return is_false ();
}

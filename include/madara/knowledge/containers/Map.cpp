...
std::string
madara::knowledge::containers::Map::get_debug_info (void)
{
...
void
madara::knowledge::containers::Map::modify_ (void)
{
  modify ();
}

std::string
madara::knowledge::containers::Map::get_debug_info_ (void)
{
...
void
madara::knowledge::containers::Map::modify (const std::string & index)
{
...
madara::knowledge::containers::Map::sync_keys (void)
{
...
void
madara::knowledge::containers::Map::exchange (
...
void
madara::knowledge::containers::Map::erase (const std::string & key)
{
  if (context_)
  {
    ContextGuard context_guard (*context_);
...
void
madara::knowledge::containers::Map::set_delimiter (
  const std::string & delimiter,
  bool sync)
{
  delimiter_ = delimiter;
...
std::string
madara::knowledge::containers::Map::get_delimiter (void)
{
  return delimiter_;
}

bool
madara::knowledge::containers::Map::exists (
...
bool
madara::knowledge::containers::Map::is_true (void) const
{
  bool result (false);
...
bool
madara::knowledge::containers::Map::is_false (void) const
{
  return !is_true ();
}
...
bool
madara::knowledge::containers::Map::is_true_ (void) const
{
  return is_true ();
}

bool
madara::knowledge::containers::Map::is_false_ (void) const
{
  return is_false ();
}

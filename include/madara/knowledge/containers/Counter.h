...
public:
   ...
   **/
  Counter(const std::string& name, KnowledgeBase& knowledge,
   ...
   **/
  Counter(const std::string& name, Variables& knowledge,
      const KnowledgeUpdateSettings& settings = KnowledgeUpdateSettings());
   ...
   * @param  settings   settings for evaluating the vector
   **/
  Counter(const std::string& name, KnowledgeBase& knowledge, int id,
      int counters, type value = 0,
      const KnowledgeUpdateSettings& settings = KnowledgeUpdateSettings());
   ...
   * @param  settings   settings for evaluating the vector
   **/
  Counter(const std::string& name, Variables& knowledge, int id, int counters,
      type value = 0,
      const KnowledgeUpdateSettings& settings = KnowledgeUpdateSettings());
...
private:
   ...
   * @return  total count
   **/
  inline knowledge::KnowledgeRecord get_count_record(void) const
  {

...
void madara::knowledge::containers::IntegerVector2D::modify_(void)
{
  modify();
}

std::string madara::knowledge::containers::IntegerVector2D::get_debug_info_(
    void)
{
...
void madara::knowledge::containers::IntegerVector2D::modify(
    const Indices& index)
{
  if(context_)
  {
...
void madara::knowledge::containers::IntegerVector2D::operator=(
    const IntegerVector2D& rhs)
{
  if(this != &rhs)
  {
...
void madara::knowledge::containers::IntegerVector2D::resize(
    const Dimensions& dimensions, bool delete_vars)
{
  if(context_ && name_ != "")
  {
...
void madara::knowledge::containers::IntegerVector2D::set_name(
...
void madara::knowledge::containers::IntegerVector2D::set_delimiter(
    const std::string& delimiter)
{
  delimiter_ = delimiter;
  if(context_)
...
void madara::knowledge::containers::IntegerVector2D::copy_to(
        ...
        const Indices& index) const
{
  ...
  if(context_)
  {
    ...
    {
      result =
          context_->get(vector_[index.x][index.y], keep_local).to_integer();
    }
  }
...
bool madara::knowledge::containers::IntegerVector2D::exists(
    const Indices& index) const
{
  bool result(false);
...
int madara::knowledge::containers::IntegerVector2D::set(
...
void madara::knowledge::containers::IntegerVector2D::set_quality(
...
bool madara::knowledge::containers::IntegerVector2D::is_true(void) const
{
  ...
  if(context_)
  {
    ...
    madara_logger_log(context_->get_logger(), logger::LOG_MINOR,
        "IntegerVector2D::is_true: context was not null. Result changed to "
        "%d\n",
        (int)result);
...
bool madara::knowledge::containers::IntegerVector2D::is_true_(void) const
{
  return is_true();
}

bool madara::knowledge::containers::IntegerVector2D::is_false_(void) const
{
  return is_false();
}

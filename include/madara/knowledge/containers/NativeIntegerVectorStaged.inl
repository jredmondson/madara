...
inline void madara::knowledge::containers::NativeIntegerVectorStaged::modify(
    void)
{
...
inline std::string
madara::knowledge::containers::NativeIntegerVectorStaged::get_debug_info(void)
{
...
inline std::string
madara::knowledge::containers::NativeIntegerVectorStaged::get_debug_info_(void)
{
  return get_debug_info();
}

inline void madara::knowledge::containers::NativeIntegerVectorStaged::operator=(
...
inline void madara::knowledge::containers::NativeIntegerVectorStaged::push_back(
    type value)
{
  if(!has_changed_)
    has_changed_ = true;
...
inline void madara::knowledge::containers::NativeIntegerVectorStaged::resize(
    size_t size)
{
  if(!has_changed_)
    has_changed_ = true;
...
inline size_t madara::knowledge::containers::NativeIntegerVectorStaged::size(
    void) const
{
  return value_.size();
}

inline void madara::knowledge::containers::NativeIntegerVectorStaged::set_name(
...
inline void madara::knowledge::containers::NativeIntegerVectorStaged::exchange(
...
inline void madara::knowledge::containers::NativeIntegerVectorStaged::copy_to(
...
inline void madara::knowledge::containers::NativeIntegerVectorStaged::set(
...
inline madara::knowledge::KnowledgeRecord
madara::knowledge::containers::NativeIntegerVectorStaged::to_record(void) const
{
  return value_;
}

inline bool madara::knowledge::containers::NativeIntegerVectorStaged::is_true(
    void) const
{
  bool result(false);
...
inline bool madara::knowledge::containers::NativeIntegerVectorStaged::is_false(
    void) const
{
  return !is_true();
}

inline void madara::knowledge::containers::NativeIntegerVectorStaged::read(void)
{
  has_changed_ = false;
  value_ = context_->get(vector_);
}

inline void madara::knowledge::containers::NativeIntegerVectorStaged::write(
    void)
{
  if(has_changed_)

...
template <typename T>
inline bool
CircularBufferT<T>::operator== (
  const CircularBufferT & value) const
{
...
template <typename T>
inline void
CircularBufferT<T>::add (const T & value)
{
...
CircularBufferT<T>::get (void) const
{
  check_all (__func__);
...
template <typename T>
inline void
CircularBufferT<T>::get (T & value) const
{
...
template <typename T>
inline void
CircularBufferT<T>::inspect (KnowledgeRecord::Integer position, T & value) const
{
...
template <typename T>
inline void
CircularBufferT<T>::inspect (KnowledgeRecord::Integer position,
...
template <typename T>
inline std::string
CircularBufferT<T>::get_name (void) const
{
  return name_;
}
...
template <typename T>
inline size_t
CircularBufferT<T>::size (void) const
{
  return buffer_.size ();
}
...
template <typename T>
inline size_t
CircularBufferT<T>::count (void) const
{
  check_context (__func__);
...
template <typename T>
inline void
CircularBufferT<T>::resize (int size)
{
  check_context (__func__);
...
CircularBufferT<T>::set_settings (
  const KnowledgeUpdateSettings & settings)
{ 
...
template <typename T>
inline void
CircularBufferT<T>::set_name (const std::string & name,
  Variables & knowledge)
{
  if (name != "")
  {
...
template <typename T>
inline void
CircularBufferT<T>::set_index (KnowledgeRecord::Integer index)
{
  check_context (__func__);
  index_ = index;
}
...
template <typename T>
inline std::vector <KnowledgeRecord>
CircularBufferT<T>::get_latest (size_t count) const
{
  check_all (__func__);
...
template <typename T>
inline void
CircularBufferT<T>::get_latest (size_t count, std::vector <T> & values) const
{
  // iterate over the returned records
...
template <typename T>
inline std::vector <KnowledgeRecord>
CircularBufferT<T>::get_earliest (size_t count) const
{
  check_all (__func__);
...
template <typename T>
inline void
CircularBufferT<T>::get_earliest (size_t count, std::vector <T> & values) const
{
  // iterate over the returned records

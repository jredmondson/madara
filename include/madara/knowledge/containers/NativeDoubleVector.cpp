...
std::string madara::knowledge::containers::NativeDoubleVector::get_debug_info(
    void)
{
...
void madara::knowledge::containers::NativeDoubleVector::modify_(void)
{
  modify();
}

std::string madara::knowledge::containers::NativeDoubleVector::get_debug_info_(
    void)
{
    ...
    NativeDoubleVector& other)
{
  if (context_ && other.context_)
  {
    ...
    madara_logger_ptr_log(logger::global_logger.get(), logger::LOG_MAJOR,
        ...
        this->name_.c_str(), other.name_.c_str());
...
int madara::knowledge::containers::NativeDoubleVector::set(
    size_t index, type value)
{
  ...
  if (context_)
  {
    ...
    madara_logger_ptr_log(logger::global_logger.get(), logger::LOG_MAJOR,
        ...
        this->name_.c_str(), (int)index, value);
...
int madara::knowledge::containers::NativeDoubleVector::set(const double* values,
...
void madara::knowledge::containers::NativeDoubleVector::set_quality(
...
madara::knowledge::containers::NativeDoubleVector::to_record(size_t index) const
{
  madara_logger_ptr_log(logger::global_logger.get(), logger::LOG_MAJOR,
...
madara::knowledge::KnowledgeRecord
madara::knowledge::containers::NativeDoubleVector::to_record(void) const
{
  madara_logger_ptr_log(logger::global_logger.get(), logger::LOG_MAJOR,
      "NativeDoubleVector::to_record: %s: retrieving record\n",
      this->name_.c_str());
...
bool madara::knowledge::containers::NativeDoubleVector::is_true_(void) const
{
  return is_true();
}

bool madara::knowledge::containers::NativeDoubleVector::is_false_(void) const
{
  return is_false();
}

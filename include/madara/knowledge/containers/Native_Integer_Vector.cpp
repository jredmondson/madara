...
madara::knowledge::containers::Native_Integer_Vector::Native_Integer_Vector (
...
void
madara::knowledge::containers::Native_Integer_Vector::modify (void)
{
...
std::string
madara::knowledge::containers::Native_Integer_Vector::get_debug_info (
  void)
{
...
void
madara::knowledge::containers::Native_Integer_Vector::modify_ (void)
{
  modify ();
}

std::string
madara::knowledge::containers::Native_Integer_Vector::get_debug_info_ (
  void)
{
...
madara::knowledge::containers::Native_Integer_Vector::clone (void) const
{
  return new Native_Integer_Vector (*this);
}

void
madara::knowledge::containers::Native_Integer_Vector::operator= (
  const Native_Integer_Vector & rhs)
{
  if (this != &rhs)
  {
...
void
madara::knowledge::containers::Native_Integer_Vector::push_back (
  type value)
{
  if (context_ && name_ != "")
  {
...
void
madara::knowledge::containers::Native_Integer_Vector::resize (
  size_t size)
{
  if (context_ && name_ != "")
  {
...
size_t
madara::knowledge::containers::Native_Integer_Vector::size (void) const
{
  Context_Guard context_guard (*context_);
  Guard guard (mutex_);
...
void
madara::knowledge::containers::Native_Integer_Vector::set_name (
...
void
madara::knowledge::containers::Native_Integer_Vector::exchange (
...
void
madara::knowledge::containers::Native_Integer_Vector::transfer_to (
  Native_Integer_Vector & other)
{
  if (context_ && other.context_)
  {
...
void
madara::knowledge::containers::Native_Integer_Vector::copy_to (
...
madara::knowledge::containers::Native_Integer_Vector::type
madara::knowledge::containers::Native_Integer_Vector::operator[] (
  size_t index) const
{
...
int
madara::knowledge::containers::Native_Integer_Vector::set (
  size_t index,
  type value)
{
  int result = -1;
...
void
madara::knowledge::containers::Native_Integer_Vector::set_quality (
  size_t index,
  uint32_t quality,
...
madara::knowledge::containers::Native_Integer_Vector::to_record (
  size_t index) const
{
...
bool
madara::knowledge::containers::Native_Integer_Vector::is_true (void) const
{
  bool result (false);
...
bool
madara::knowledge::containers::Native_Integer_Vector::is_false (void) const
{
  return !is_true ();
}
...
bool
madara::knowledge::containers::Native_Integer_Vector::is_true_ (void) const
{
  return is_true ();
}

bool
madara::knowledge::containers::Native_Integer_Vector::is_false_ (void) const
{
  return is_false ();
}

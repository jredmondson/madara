...
#ifndef _MADARA_KNOWLEDGE_CONTAINERS_INTEGERSTAGED_H_
#define _MADARA_KNOWLEDGE_CONTAINERS_INTEGERSTAGED_H_
 ...
 *        called.
 */
class MADARA_EXPORT IntegerStaged : public BaseContainer
{
public:
   ...
   * @param  settings   settings for updating knowledge
   **/
  IntegerStaged(const std::string& name, KnowledgeBase& knowledge,
      const KnowledgeUpdateSettings& settings = KnowledgeUpdateSettings());
   ...
   * @param  settings  settings for updating knowledge
   **/
  IntegerStaged(const std::string& name, Variables& knowledge,
      const KnowledgeUpdateSettings& settings = KnowledgeUpdateSettings());
   ...
   * @param  settings   settings for updating knowledge
   **/
  IntegerStaged(const std::string& name, KnowledgeBase& knowledge, type value,
      const KnowledgeUpdateSettings& settings = KnowledgeUpdateSettings());
   ...
   * @param  settings   settings for updating knowledge
   **/
  IntegerStaged(const std::string& name, Variables& knowledge, type value,
      const KnowledgeUpdateSettings& settings = KnowledgeUpdateSettings());
  ...
  /**
   * Mark the value as modified. The IntegerStaged retains the same value
...
#include "IntegerStaged.inl"

#endif  // _MADARA_KNOWLEDGE_CONTAINERS_INTEGERSTAGED_H_

...
inline void
madara::knowledge::containers::StringStaged::modify (void)
{
...
inline std::string
madara::knowledge::containers::StringStaged::get_debug_info (void)
{
...
inline void
madara::knowledge::containers::StringStaged::operator= (const StringStaged & rhs)
{
  if (this != &rhs)
  {
...
inline void
madara::knowledge::containers::StringStaged::set_name (
...
inline bool
madara::knowledge::containers::StringStaged::operator== (const type & value) const
{
  return value_ == value;
}
...
inline bool
madara::knowledge::containers::StringStaged::operator== (
...
inline bool
madara::knowledge::containers::StringStaged::exists (void) const
{
  bool result (false);
...
inline bool
madara::knowledge::containers::StringStaged::is_true (void) const
{
  return value_ != "";
}

inline bool
madara::knowledge::containers::StringStaged::is_false (void) const
{
  return value_ == "";
}
...
inline double
madara::knowledge::containers::StringStaged::to_double (void) const
{
  KnowledgeRecord value (value_);
...
inline std::string
madara::knowledge::containers::StringStaged::to_string (void) const
{
  return value_;
}

inline void
madara::knowledge::containers::StringStaged::set_quality (
  uint32_t quality,
...
inline void
madara::knowledge::containers::StringStaged::write (void)
{
  if (has_changed_)

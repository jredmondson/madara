...
void
madara::knowledge::containers::Collection::modify_ (void)
{
  modify ();
}

std::string
madara::knowledge::containers::Collection::get_debug_info_ (void)
{
...
bool
madara::knowledge::containers::Collection::is_true (void) const
{
  bool result (true);
...
bool
madara::knowledge::containers::Collection::is_false (void) const
{
  return !is_true ();
}
...
bool
madara::knowledge::containers::Collection::is_true_ (void) const
{
  return is_true ();
}

bool
madara::knowledge::containers::Collection::is_false_ (void) const
{
  return is_false ();
}

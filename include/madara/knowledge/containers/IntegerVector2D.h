...
public:
   ...
   * @param  delimiter  the delimiter for variables in the vector
   **/
  IntegerVector2D(const std::string& name, KnowledgeBase& knowledge,
      const Dimensions& dimensions = {0, 0}, bool delete_vars = true,
      const KnowledgeUpdateSettings& settings = KnowledgeUpdateSettings(),
      const std::string& delimiter = ".");
   ...
   * @param  delimiter  the delimiter for variables in the vector
   **/
  IntegerVector2D(const std::string& name, Variables& knowledge,
      const Dimensions& dimensions = {0, 0}, bool delete_vars = true,
      const KnowledgeUpdateSettings& settings = KnowledgeUpdateSettings(),
      const std::string& delimiter = ".");

...
madara::knowledge::containers::DoubleStaged::DoubleStaged (const DoubleStaged & rhs)
...
void
madara::knowledge::containers::DoubleStaged::modify_ (void)
{
  modify ();
}

std::string
madara::knowledge::containers::DoubleStaged::get_debug_info_ (void)
{
  return get_debug_info ();
}

void
madara::knowledge::containers::DoubleStaged::exchange (
...
bool
madara::knowledge::containers::DoubleStaged::is_true_ (void) const
{
  return is_true ();
}

bool
madara::knowledge::containers::DoubleStaged::is_false_ (void) const
{
  return is_false ();
}

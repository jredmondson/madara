...
void
madara::knowledge::containers::StringVector::modify (void)
{
  if (context_ && name_ != "")
  {
...
std::string
madara::knowledge::containers::StringVector::get_debug_info (void)
{
...
void
madara::knowledge::containers::StringVector::modify_ (void)
{
  modify ();
}

std::string
madara::knowledge::containers::StringVector::get_debug_info_ (void)
{
...
void
madara::knowledge::containers::StringVector::modify (size_t index)
{
...
void
madara::knowledge::containers::StringVector::push_back (type value)
{
  if (context_ && name_ != "")
  {
    ContextGuard context_guard (*context_);
...
void
madara::knowledge::containers::StringVector::resize (
...
size_t
madara::knowledge::containers::StringVector::size (void) const
{
  Guard guard (mutex_);
  return vector_.size ();
}
...
void
madara::knowledge::containers::StringVector::set_name (
...
void
madara::knowledge::containers::StringVector::set_delimiter (
const std::string & delimiter)
{
  delimiter_ = delimiter;
  if (context_)
...
std::string
madara::knowledge::containers::StringVector::get_delimiter (void)
{
  return delimiter_;
}

void
madara::knowledge::containers::StringVector::exchange (
...
void
madara::knowledge::containers::StringVector::transfer_to (StringVector & other)
{
  if (context_ && other.context_)
  {
    ContextGuard context_guard (*context_);
...
void
madara::knowledge::containers::StringVector::copy_to (
...
bool
madara::knowledge::containers::StringVector::exists (
  size_t index) const
{
  bool result (false);
...
int
madara::knowledge::containers::StringVector::set (
  size_t index,
  const type & value)
{
  int result = -1;
...
void
madara::knowledge::containers::StringVector::set_quality (
  size_t index,
  uint32_t quality,
...
bool
madara::knowledge::containers::StringVector::is_true (void) const
{
  bool result (false);
...
bool
madara::knowledge::containers::StringVector::is_false (void) const
{
  return !is_true ();
}
...
bool
madara::knowledge::containers::StringVector::is_true_ (void) const
{
  return is_true ();
}

bool
madara::knowledge::containers::StringVector::is_false_ (void) const
{
  return is_false ();
}

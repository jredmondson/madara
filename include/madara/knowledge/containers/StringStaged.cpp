...
void
madara::knowledge::containers::StringStaged::modify_ (void)
{
  modify ();
}

std::string
madara::knowledge::containers::StringStaged::get_debug_info_ (void)
{
  return get_debug_info ();
}

void
madara::knowledge::containers::StringStaged::exchange (
...
bool
madara::knowledge::containers::StringStaged::is_true_ (void) const
{
  return is_true ();
}

bool
madara::knowledge::containers::StringStaged::is_false_ (void) const
{
  return is_false ();
}

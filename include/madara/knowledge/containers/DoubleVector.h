...
#ifndef _MADARA_CONTAINERS_DOUBLE_VECTOR_H_
#define _MADARA_CONTAINERS_DOUBLE_VECTOR_H_
...
public:
   ...
   * @param  delimiter  the delimiter for variables in the vector
   **/
  DoubleVector(const std::string& name, KnowledgeBase& knowledge, int size = -1,
   ...
   * @param  delimiter  the delimiter for variables in the vector
   **/
  DoubleVector(const std::string& name, Variables& knowledge, int size = -1,
      bool delete_vars = true,
      const KnowledgeUpdateSettings& settings = KnowledgeUpdateSettings(),
      const std::string& delimiter = ".");
   ...
   **/
  void exchange(
      DoubleVector& other, bool refresh_keys = true, bool delete_keys = true);
...
#endif  // _MADARA_CONTAINERS_DOUBLE_VECTOR_H_

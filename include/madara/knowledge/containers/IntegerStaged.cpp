...
void
madara::knowledge::containers::IntegerStaged::modify_ (void)
{
  modify ();
}

std::string
madara::knowledge::containers::IntegerStaged::get_debug_info_ (void)
{
  return get_debug_info ();
}

void
madara::knowledge::containers::IntegerStaged::exchange (
...
bool
madara::knowledge::containers::IntegerStaged::is_true_ (void) const
{
  return is_true ();
}

bool
madara::knowledge::containers::IntegerStaged::is_false_ (void) const
{
  return is_false ();
}

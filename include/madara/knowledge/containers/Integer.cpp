...
madara::knowledge::containers::Integer::Integer(const std::string& name,
...
void madara::knowledge::containers::Integer::modify_(void)
{
  modify();
}

std::string madara::knowledge::containers::Integer::get_debug_info_(void)
{
...
bool madara::knowledge::containers::Integer::is_true_(void) const
{
  return is_true();
}

bool madara::knowledge::containers::Integer::is_false_(void) const
{
  return is_false();
}

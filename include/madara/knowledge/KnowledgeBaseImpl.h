  ...
  namespace knowledge
  {
    ...
    public:
      ...
      **/
       ...
       **/
      madara::KnowledgeRecord evaluate (const std::string & expression);
       ...
       * @return                value of expression
       **/
      madara::KnowledgeRecord wait (const std::string & expression);
       ...
       * @return                value of expression
       **/
      madara::KnowledgeRecord wait (CompiledExpression & expression,
        const WaitSettings & settings);
       ...
       **/
      int set (const std::string & key, madara::KnowledgeRecord::Integer value, 
        const EvalSettings & settings);

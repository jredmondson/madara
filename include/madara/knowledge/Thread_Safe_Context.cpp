...
// constructor
madara::knowledge::Thread_Safe_Context::Thread_Safe_Context ()
...
// destructor
madara::knowledge::Thread_Safe_Context::~Thread_Safe_Context (void)
{
#ifndef _MADARA_NO_KARL_
  delete interpreter_;
#endif // _MADARA_NO_KARL_
...
madara::knowledge::Thread_Safe_Context::get_record (
...
madara::knowledge::Thread_Safe_Context::get_ref (
  const std::string & key,
  const Knowledge_Reference_Settings & settings)
{
  std::string key_actual;
...
void
madara::knowledge::Thread_Safe_Context::mark_and_signal (
...
uint32_t 
madara::knowledge::Thread_Safe_Context::get_quality (
  const std::string & key,
  const Knowledge_Reference_Settings & settings)
{
  // enter the mutex
...
/// @return    quality of the variable 
uint32_t 
madara::knowledge::Thread_Safe_Context::get_write_quality (
  const std::string & key,
  const Knowledge_Reference_Settings & settings)
{
  // enter the mutex
...
uint32_t 
madara::knowledge::Thread_Safe_Context::set_quality (
...
void 
madara::knowledge::Thread_Safe_Context::set_write_quality (
  const std::string & key, uint32_t quality,
  const Knowledge_Reference_Settings & settings)
{
  // enter the mutex
...
int
madara::knowledge::Thread_Safe_Context::set_if_unequal (
...
///           -1 if null key, -2 if quality not high enough
int
madara::knowledge::Thread_Safe_Context::update_record_from_external (
...
void 
madara::knowledge::Thread_Safe_Context::set_changed (void)
{
  changed_.signal ();
}
...
// print all variables and their values
void
madara::knowledge::Thread_Safe_Context::to_string (
  std::string & target,
...
/// keys.
std::string 
madara::knowledge::Thread_Safe_Context::expand_statement (
...
void
madara::knowledge::Thread_Safe_Context::define_function (
...
#ifdef _MADARA_JAVA_
void
madara::knowledge::Thread_Safe_Context::define_function (const std::string & name,
  jobject callable,
  const Knowledge_Reference_Settings & settings)
{
  // enter the mutex
...
madara::knowledge::Thread_Safe_Context::retrieve_function (
  const std::string & name,
  const Knowledge_Reference_Settings & settings)
{
  // enter the mutex
...
madara::knowledge::Thread_Safe_Context::compile (
  const std::string & expression)
{
...
size_t
  madara::knowledge::Thread_Safe_Context::to_vector (
...
size_t
  madara::knowledge::Thread_Safe_Context::to_map (
  const std::string & expression,
...
void
madara::knowledge::Thread_Safe_Context::copy (
...
int64_t
madara::knowledge::Thread_Safe_Context::save_context (
  const std::string & filename,
...
int64_t
madara::knowledge::Thread_Safe_Context::save_as_karl (
...
int64_t
madara::knowledge::Thread_Safe_Context::load_context (
...
int64_t
madara::knowledge::Thread_Safe_Context::save_checkpoint (
  const std::string & filename,
  const std::string & id) const
{
  madara_logger_ptr_log (logger_, logger::LOG_MAJOR,

...
namespace knowledge
{
inline KnowledgeBaseImpl::KnowledgeBaseImpl() : settings_()
{
  // activate_transport ();
}
...
inline KnowledgeRecord KnowledgeBaseImpl::get(
    const std::string& t_key, const KnowledgeReferenceSettings& settings)
{
  return map_.get(t_key, settings);
}

inline KnowledgeRecord KnowledgeBaseImpl::get(const VariableReference& variable,
    const KnowledgeReferenceSettings& settings)
{
  return map_.get(variable, settings);
}

inline VariableReference KnowledgeBaseImpl::get_ref(
    const std::string& t_key, const KnowledgeReferenceSettings& settings)
{
  return map_.get_ref(t_key, settings);
}

inline int KnowledgeBaseImpl::get_log_level(void)
{
  return map_.get_log_level();
}

inline std::string KnowledgeBaseImpl::debug_modifieds(void) const
{
  return map_.debug_modifieds();
}

inline madara::logger::Logger& KnowledgeBaseImpl::get_logger(void) const
{
  return map_.get_logger();
}

inline void KnowledgeBaseImpl::attach_logger(logger::Logger& logger) const
{
  map_.attach_logger(logger);
}

inline void KnowledgeBaseImpl::set_log_level(int level)
{
  map_.set_log_level(level);
}

inline KnowledgeRecord KnowledgeBaseImpl::retrieve_index(
    const std::string& t_key, size_t index,
    const KnowledgeReferenceSettings& settings)
{
...
inline bool KnowledgeBaseImpl::exists(
    const std::string& key, const KnowledgeReferenceSettings& settings) const
{
  return map_.exists(key, settings);
}

inline bool KnowledgeBaseImpl::exists(const VariableReference& variable,
...
/// Read a file into the knowledge base
inline int KnowledgeBaseImpl::set_file(const VariableReference& variable,
...
/// Read a file into the knowledge base
inline int KnowledgeBaseImpl::set_jpeg(const VariableReference& variable,
    const unsigned char* value, size_t size, const EvalSettings& settings)
{
...
/// Read a file into the knowledge base
inline int KnowledgeBaseImpl::read_file(const VariableReference& variable,
    const std::string& filename, const EvalSettings& settings)
{
...
inline void KnowledgeBaseImpl::copy(const KnowledgeBaseImpl& source,
...
inline void KnowledgeBaseImpl::lock(void)
{
  map_.lock();
}

inline void KnowledgeBaseImpl::unlock(void)
{
  map_.unlock();
}

inline std::string KnowledgeBaseImpl::expand_statement(
...
inline ssize_t KnowledgeBaseImpl::write_file(
...
inline void KnowledgeBaseImpl::set_quality(const std::string& t_key,
...
inline void KnowledgeBaseImpl::print(unsigned int level) const
{
...
inline void KnowledgeBaseImpl::to_string(std::string& target,
    const std::string& array_delimiter, const std::string& record_delimiter,
    const std::string& key_val_delimiter) const
{
  map_.to_string(target, array_delimiter, record_delimiter, key_val_delimiter);
}

inline void KnowledgeBaseImpl::print(
    const std::string& statement, unsigned int level) const
{
  map_.print(statement, level);
}

inline bool KnowledgeBaseImpl::clear(
    const std::string& key, const KnowledgeReferenceSettings& settings)
{
  return map_.clear(key, settings);
}

inline void KnowledgeBaseImpl::clear(bool erase)
{
  map_.clear(erase);
}

inline void KnowledgeBaseImpl::clear_map(void)
{
  map_.clear();
}
...
// Defines a function
inline void KnowledgeBaseImpl::define_function(const std::string& name,
...
#ifdef _MADARA_JAVA_
inline void KnowledgeBaseImpl::define_function(
...
inline KnowledgeRecord KnowledgeBaseImpl::wait(const std::string& expression)
{
 ...
 **/
inline ThreadSafeContext& KnowledgeBaseImpl::get_context(void)
{
  return map_;
}
 ...
 **/
inline size_t KnowledgeBaseImpl::to_vector(const std::string& subject,
    unsigned int start, unsigned int end, std::vector<KnowledgeRecord>& target)
{
  return map_.to_vector(subject, start, end, target);
}

inline void KnowledgeBaseImpl::get_matches(const std::string& prefix,
    const std::string& suffix, VariableReferences& matches)
{
  map_.get_matches(prefix, suffix, matches);
}

inline size_t KnowledgeBaseImpl::to_map(const std::string& expression,
    std::map<std::string, KnowledgeRecord>& target)
{
  return map_.to_map(expression, target);
}

inline size_t KnowledgeBaseImpl::to_map(const std::string& prefix,
    const std::string& delimiter, const std::string& suffix,
    std::vector<std::string>& next_keys,
    std::map<std::string, KnowledgeRecord>& result, bool just_keys)
{
  return map_.to_map(prefix, delimiter, suffix, next_keys, result, just_keys);
}

inline KnowledgeMap KnowledgeBaseImpl::to_map(const std::string& prefix) const
{
  return map_.to_map(prefix);
}

inline KnowledgeMap KnowledgeBaseImpl::to_map_stripped(
    const std::string& prefix) const
{
  return map_.to_map_stripped(prefix);
}

inline int64_t KnowledgeBaseImpl::save_context(
...
inline int64_t KnowledgeBaseImpl::save_as_json(
    const std::string& filename) const
{
...
inline int64_t KnowledgeBaseImpl::save_as_karl(
    const std::string& filename) const
{
...
inline void KnowledgeBaseImpl::clear_modifieds(void)
{
  map_.reset_modified();
}

inline void madara::knowledge::KnowledgeBaseImpl::reset_checkpoint(void) const
{
  map_.reset_checkpoint();
}

inline int64_t KnowledgeBaseImpl::save_checkpoint(
...
inline int64_t KnowledgeBaseImpl::load_context(const std::string& filename,
...
inline int64_t KnowledgeBaseImpl::load_context(
...
inline madara::knowledge::KnowledgeRecord KnowledgeBaseImpl::evaluate_file(
    CheckpointSettings& checkpoint_settings,
    const KnowledgeUpdateSettings& update_settings)
{
...
inline std::string KnowledgeBaseImpl::file_to_string(
    CheckpointSettings& checkpoint_settings)
{
  return map_.file_to_string(checkpoint_settings);
}

inline void KnowledgeBaseImpl::add_modifieds(
    const VariableReferences& modifieds) const
{
  map_.add_modifieds(modifieds);
}

inline VariableReferences KnowledgeBaseImpl::save_modifieds(void) const
{

...
madara::knowledge::Knowledge_Record_Filters::Knowledge_Record_Filters ()
  : context_ (0)
{
}
...
void
madara::knowledge::Knowledge_Record_Filters::operator= (
...
void
madara::knowledge::Knowledge_Record_Filters::add (uint32_t types,
...
void
madara::knowledge::Knowledge_Record_Filters::add (
  void (*function) (
...
void
madara::knowledge::Knowledge_Record_Filters::attach (
...
void
madara::knowledge::Knowledge_Record_Filters::clear (uint32_t types)
{
  // start with 1st bit, check every bit until types is 0
  for (uint32_t cur = 1; types > 0; cur <<= 1)
  {
...
void
madara::knowledge::Knowledge_Record_Filters::clear_aggregate_filters (
  void)
{
...
void
madara::knowledge::Knowledge_Record_Filters::clear_buffer_filters (
void)
{
...
void
madara::knowledge::Knowledge_Record_Filters::print_num_filters (
  void) const
{
  if (context_)
  {
...
madara::knowledge::Knowledge_Record_Filters::filter (
...
void madara::knowledge::Knowledge_Record_Filters::filter_decode (
...
void madara::knowledge::Knowledge_Record_Filters::filter_encode (
  unsigned char * source, int size, int max_size) const
{
...
size_t
madara::knowledge::Knowledge_Record_Filters::get_number_of_filtered_types (
  void) const
{
...
size_t
madara::knowledge::Knowledge_Record_Filters::get_number_of_aggregate_filters (
  void) const
{
...
size_t
madara::knowledge::Knowledge_Record_Filters::get_number_of_buffer_filters (
void) const
{

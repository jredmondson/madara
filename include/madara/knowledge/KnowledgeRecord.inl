...
namespace knowledge
{
inline KnowledgeRecord::KnowledgeRecord(logger::Logger& logger) noexcept
  : logger_(&logger)
{
}
...
inline KnowledgeRecord::KnowledgeRecord(
    const std::vector<double>& value, logger::Logger& logger)
  : logger_(&logger)
{
  set_value(value);
}
...
inline KnowledgeRecord::KnowledgeRecord(
    std::vector<double>&& value, logger::Logger& logger) noexcept
  : logger_(&logger)
{
  set_value(std::move(value));
}
...
inline KnowledgeRecord::KnowledgeRecord(
    std::unique_ptr<std::vector<double>> value, logger::Logger& logger) noexcept
  : logger_(&logger)
{
  set_value(std::move(value));
}
...
inline KnowledgeRecord::KnowledgeRecord(
    const std::string& value, logger::Logger& logger)
  : logger_(&logger)
{
  set_value(value);
}
...
inline KnowledgeRecord::KnowledgeRecord(
    std::string&& value, logger::Logger& logger) noexcept
  : logger_(&logger)
{
  set_value(std::move(value));
}
...
inline KnowledgeRecord::KnowledgeRecord(
    std::unique_ptr<std::string> value, logger::Logger& logger) noexcept
  : logger_(&logger)
{
  set_value(std::move(value));
}
...
inline KnowledgeRecord::KnowledgeRecord(
    const char* value, logger::Logger& logger)
  : logger_(&logger)
{
    ...
    shared_(rhs.is_ref_counted() ? SHARED : OWNED)
{
  ...
  if (rhs.type_ == INTEGER)
    ...
    new (&double_array_)
        std::shared_ptr<std::vector<double>>(rhs.double_array_);
    ...
    new (&file_value_)
        std::shared_ptr<std::vector<unsigned char>>(rhs.file_value_);
    ...
    shared_(rhs.shared_)
{
  ...
  if (rhs.type_ == INTEGER)
    ...
    new (&int_array_)
        std::shared_ptr<std::vector<Integer>>(std::move(rhs.int_array_));
  else if (rhs.type_ == DOUBLE)
    double_value_ = rhs.double_value_;
  else if (rhs.type_ == DOUBLE_ARRAY)
    new (&double_array_)
        std::shared_ptr<std::vector<double>>(std::move(rhs.double_array_));
  else if (is_string_type(rhs.type_))
    new (&str_value_) std::shared_ptr<std::string>(std::move(rhs.str_value_));
  else if (is_binary_file_type(rhs.type_))
    new (&file_value_)
        std::shared_ptr<std::vector<unsigned char>>(std::move(rhs.file_value_));
  else if (rhs.type_ == BUFFER)
...
inline void KnowledgeRecord::copy_metadata(const KnowledgeRecord& rhs)
{
  logger_ = rhs.logger_;
  clock = rhs.clock;
  toi_ = rhs.toi_;
...
inline void KnowledgeRecord::set_value(const KnowledgeRecord& rhs)
{
  if (this == &rhs)
    return;
  ...
  if (has_history())
  {
    KnowledgeRecord tmp = rhs.has_history() ? rhs.get_newest() : rhs;
...
inline void KnowledgeRecord::set_value(KnowledgeRecord&& rhs)
{
  if (this == &rhs)
    return;
  ...
  {
    KnowledgeRecord tmp =
        rhs.has_history() ? std::move(rhs.ref_newest()) : std::move(rhs);
    emplace_hist(std::move(tmp));
  }
  else if (rhs.has_history())
  {
...
inline void KnowledgeRecord::set_full(const KnowledgeRecord& rhs)
{
  if (this == &rhs)
    return;
...
inline void KnowledgeRecord::set_full(KnowledgeRecord&& rhs)
{
  if (this == &rhs)
    return;
...
inline void KnowledgeRecord::overwrite(const KnowledgeRecord& rhs)
{
  if (this == &rhs)
    return;
...
inline void KnowledgeRecord::overwrite(KnowledgeRecord&& rhs)
{
  if (this == &rhs)
    return;
...
inline KnowledgeRecord& KnowledgeRecord::operator=(
...
inline bool KnowledgeRecord::operator!=(
 ...
 * Logical not.
 **/
inline bool KnowledgeRecord::operator!(void)const
{
  return !is_true();
}
 ...
 * Negate.
 **/
inline KnowledgeRecord KnowledgeRecord::operator-(void) const
{
 ...
 **/
inline KnowledgeRecord& KnowledgeRecord::operator--(void)
{
  if (is_integer_type(type_))
...
inline bool KnowledgeRecord::is_false(void) const
{
  return !is_true();
}
...
inline std::ostream& operator<<(
    std::ostream& stream, const KnowledgeRecord& rhs)
{
  if (rhs.type() &
      (KnowledgeRecord::INTEGER_ARRAY | KnowledgeRecord::DOUBLE_ARRAY))
  {
...
inline void KnowledgeRecord::unshare(void)
{
  if (shared_ != SHARED)
  {
    return;
...
inline KnowledgeRecord* KnowledgeRecord::clone(void) const
{
...
inline void KnowledgeRecord::deep_copy(const knowledge::KnowledgeRecord& source)
{
  *this = source;
  unshare();
}

inline KnowledgeRecord KnowledgeRecord::deep_copy() const
{
...
inline bool KnowledgeRecord::exists(void) const
{
  return !(type_ == EMPTY || (type_ == BUFFER && buf_->empty()));
}

inline int KnowledgeRecord::status(void) const
{
 ...
 **/
inline void KnowledgeRecord::set_modified(void)
{
  if (!exists())
  {
    set_value((Integer)0);
...
inline uint32_t KnowledgeRecord::size(void) const
{
...
inline uint32_t KnowledgeRecord::type(void) const
{
  return has_history() ? (buf_->empty() ? EMPTY : ref_newest().type_) : type_;
}

inline bool KnowledgeRecord::set_type(uint32_t type)
{
  if (type == type_ || (is_string_type(type_) && is_string_type(type)) ||
...
inline int64_t KnowledgeRecord::get_encoded_size(void) const
{
  int64_t buffer_size(sizeof(type_) + sizeof(uint32_t) + sizeof(toi_) + 0);
...
inline int64_t KnowledgeRecord::get_encoded_size(const std::string& key) const
{
  // for keyed size, add another uint32_t and the size of the key with a null
  // char
...
inline bool KnowledgeRecord::is_ref_counted(void) const
{
  return is_ref_counted(type_);
}

inline bool KnowledgeRecord::is_ref_counted(uint32_t type)
{
  return type != INTEGER && type != DOUBLE;
}

inline bool KnowledgeRecord::is_string_type(void) const
{
  return is_string_type(type());
}

inline bool KnowledgeRecord::is_string_type(uint32_t type)
{
  return type == STRING || type == XML || type == TEXT_FILE;
}

inline bool KnowledgeRecord::is_double_type(void) const
{
  return is_double_type(type());
}

inline bool KnowledgeRecord::is_double_type(uint32_t type)
{
  return type == DOUBLE || type == DOUBLE_ARRAY;
}

inline bool KnowledgeRecord::is_integer_type(void) const
{
  return is_integer_type(type());
}

inline bool KnowledgeRecord::is_integer_type(uint32_t type)
{
  return type == EMPTY || type == INTEGER || type == INTEGER_ARRAY;
}

inline bool KnowledgeRecord::is_array_type(void) const
{
  return is_array_type(type());
}

inline bool KnowledgeRecord::is_array_type(uint32_t type)
{
  return (type & ALL_ARRAYS) != 0;
}

inline bool KnowledgeRecord::is_image_type(void) const
{
  return is_image_type(type());
}

inline bool KnowledgeRecord::is_image_type(uint32_t type)
{
  return type == IMAGE_JPEG;
}

inline bool KnowledgeRecord::is_file_type(void) const
{
  return is_file_type(type());
}

inline bool KnowledgeRecord::is_file_type(uint32_t type)
{
  return type == TEXT_FILE || type == XML || type == IMAGE_JPEG ||
         type == UNKNOWN_FILE_TYPE;
}

inline bool KnowledgeRecord::is_binary_file_type(void) const
{
  return is_binary_file_type(type());
}

inline bool KnowledgeRecord::is_binary_file_type(uint32_t type)
{
  return type == IMAGE_JPEG || type == UNKNOWN_FILE_TYPE;
}

inline uint32_t max_quality(const knowledge::KnowledgeRecords& records)
{
  uint32_t max = 0;

  // iterate over the list and return the max
  for (KnowledgeRecords::const_iterator i = records.begin(); i != records.end();
       ++i)
  {
...
inline uint32_t max_quality(const KnowledgeMap& records)
{
  uint32_t max = 0;

  // iterate over the list and return the max
  for (KnowledgeMap::const_iterator i = records.begin(); i != records.end();
       ++i)
  {
    max = std::max<uint32_t>(i->second.quality, max);
  }
...
inline void KnowledgeRecord::clear_union(void) noexcept
{
...
inline void KnowledgeRecord::clear_value(void) noexcept
{
  clear_union();
...
inline const char* KnowledgeRecord::read(
...
// reset the to empty
inline void KnowledgeRecord::reset_value(void) noexcept
{
  clear_value();
...
inline void KnowledgeRecord::set_value(std::string&& new_value)
{
...
// set the value_ to a string
inline void KnowledgeRecord::set_value(const std::string& new_value)
{
...
// set the value_ to a string
inline void KnowledgeRecord::set_value(std::unique_ptr<std::string> new_value)
{
...
// set the value_ to a string
inline void KnowledgeRecord::set_value(const char* new_value, uint32_t size)
{
...
// set the value_ to a string
inline void KnowledgeRecord::set_xml(const char* new_value, size_t size)
{
  emplace_string(new_value, size);
  type_ = XML;
}
...
// set the value_ to a string
inline void KnowledgeRecord::set_xml(std::string&& new_value)
{
  emplace_string(std::move(new_value));
  type_ = XML;
}
...
// set the value_ to a string
inline void KnowledgeRecord::set_xml(const std::string& new_value)
{
  emplace_string(new_value);
  type_ = XML;
}
...
// set the value_ to a string
inline void KnowledgeRecord::set_xml(std::unique_ptr<std::string> new_value)
{
...
// set the value_ to a string
inline void KnowledgeRecord::set_text(const char* new_value, size_t size)
{
  emplace_string(new_value, size);
  type_ = TEXT_FILE;
}
...
// set the value_ to a string
inline void KnowledgeRecord::set_text(std::string&& new_value)
{
  emplace_string(std::move(new_value));
  type_ = TEXT_FILE;
}
...
// set the value_ to a string
inline void KnowledgeRecord::set_text(const std::string& new_value)
{
  emplace_string(new_value);
  type_ = TEXT_FILE;
}
...
// set the value_ to a string
inline void KnowledgeRecord::set_text(std::unique_ptr<std::string> new_value)
{
...
// set the value_ to a string
inline void KnowledgeRecord::set_jpeg(
...
inline void KnowledgeRecord::set_jpeg(std::vector<unsigned char>&& new_value)
{
...
// set the value_ to a string
inline void KnowledgeRecord::set_file(
    const unsigned char* new_value, size_t size)
{
  emplace_file(new_value, new_value + size);
...
inline void KnowledgeRecord::set_file(std::vector<unsigned char>&& new_value)
{
  emplace_file(std::move(new_value));
  type_ = UNKNOWN_FILE_TYPE;
}
...
inline void KnowledgeRecord::set_value(Integer new_value)
{
  if (has_history())
  {
    KnowledgeRecord tmp;
...
inline void KnowledgeRecord::set_value(int new_value)
{
  if (has_history())
  {
    KnowledgeRecord tmp;
  ...
  int_value_ = (Integer)new_value;
}

inline void KnowledgeRecord::set_value(size_t new_value)
{
  if (has_history())
  {
    KnowledgeRecord tmp;
...
inline void KnowledgeRecord::set_value(double new_value)
{
  if (has_history())
  {
    KnowledgeRecord tmp;
...
// set the value_ to a float
inline void KnowledgeRecord::set_value(float new_value)
{
  if (has_history())
  {
    KnowledgeRecord tmp;
  ...
  double_value_ = (double)new_value;
}

// set the value_ to an array of doubles
inline void KnowledgeRecord::set_value(const Integer* new_value, uint32_t size)
{
  emplace_integers(new_value, new_value + size);
}

// set the value_ to an array of integers
inline void KnowledgeRecord::set_value(std::vector<Integer>&& new_value)
{
  emplace_integers(std::move(new_value));
}

// set the value_ to an array of integers
inline void KnowledgeRecord::set_value(const std::vector<Integer>& new_value)
{
  emplace_integers(new_value);
}

// set the value_ to an array of integers
inline void KnowledgeRecord::set_value(
    std::unique_ptr<std::vector<Integer>> new_value)
{
  emplace_shared_vec<Integer, INTEGER_ARRAY, &KnowledgeRecord::int_array_>(
      std::move(new_value));
}

// set the value_ to an array of doubles
inline void KnowledgeRecord::set_value(const double* new_value, uint32_t size)
{
  emplace_doubles(new_value, new_value + size);
}

// set the value_ to an array of doubles
inline void KnowledgeRecord::set_value(std::vector<double>&& new_value)
{
  emplace_doubles(std::move(new_value));
}

// set the value_ to an array of doubles
inline void KnowledgeRecord::set_value(const std::vector<double>& new_value)
{
...
// set the value_ to an array of doubles
inline void KnowledgeRecord::set_value(
    std::unique_ptr<std::vector<double>> new_value)
{
  emplace_shared_vec<double, DOUBLE_ARRAY, &KnowledgeRecord::double_array_>(
      std::move(new_value));
}
...
inline KnowledgeRecord::operator bool(void) const
{
  return is_true();
}

inline char* KnowledgeRecord::write(
    char* buffer, int64_t& buffer_remaining) const
{
...
inline char* KnowledgeRecord::write(
    char* buffer, uint32_t key_id, int64_t& buffer_remaining) const
{
  // format is [key_id | type | value_size | value]

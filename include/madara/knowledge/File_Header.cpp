...
madara::knowledge::File_Header::File_Header ()
: size (encoded_size ()),
...
uint32_t
madara::knowledge::File_Header::encoded_size (void)
{
...
const char *
madara::knowledge::File_Header::read (const char * buffer,
...
char *
madara::knowledge::File_Header::write (char * buffer,
                                         int64_t & buffer_remaining)
{
...
bool
madara::knowledge::File_Header::equals (const File_Header & other)
{

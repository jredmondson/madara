...
#ifndef _MADARA_INTEGER_VECTOR_H_
#define _MADARA_INTEGER_VECTOR_H_
...
namespace Madara
{
  namespace Knowledge_Engine
  {
    namespace Containers
    {
       ...
       */
      class MADARA_Export Integer_Vector
      {
      public:
         ...
         * Copy constructor
         **/
        Integer_Vector (const Integer_Vector & rhs);
         ...
         **/
        void operator= (const Integer_Vector & rhs);
        ...
        **/
         ...
         **/
        void exchange (Integer_Vector & other, bool refresh_keys = true,
         ...
         **/
        void transfer_to (Integer_Vector & other);
      ...
      typedef  Integer_Vector   Integer_Array;
    }
  }
}

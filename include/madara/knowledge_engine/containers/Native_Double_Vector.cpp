...
std::string
Madara::Knowledge_Engine::Containers::Native_Double_Vector::get_debug_info (
  void)
{
...
void
Madara::Knowledge_Engine::Containers::Native_Double_Vector::modify_ (void)
{
  modify ();
}

std::string
Madara::Knowledge_Engine::Containers::Native_Double_Vector::get_debug_info_ (
  void)
{
...
Madara::Knowledge_Engine::Containers::Native_Double_Vector::clone (void) const
{
...
void
Madara::Knowledge_Engine::Containers::Native_Double_Vector::push_back (
  type value)
{
  if (context_ && name_ != "")
  {
...
bool
Madara::Knowledge_Engine::Containers::Native_Double_Vector::is_true (void) const
{
  bool result (false);

  madara_logger_log (context_->get_logger (), Logger::LOG_MAJOR,
    "Native_Double_Vector::is_true: Checking for non-zero value\n");
  ...
  madara_logger_log (context_->get_logger (), Logger::LOG_MAJOR,
    "Native_Double_Vector::is_true: final result is %d\n",
    (int)result);
...
bool
Madara::Knowledge_Engine::Containers::Native_Double_Vector::is_false (void) const
{
  return !is_true ();
}
...
bool
Madara::Knowledge_Engine::Containers::Native_Double_Vector::is_true_ (void) const
{
  return is_true ();
}

bool
Madara::Knowledge_Engine::Containers::Native_Double_Vector::is_false_ (void) const
{
  return is_false ();
}

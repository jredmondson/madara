...
std::string
Madara::Knowledge_Engine::Containers::String_Vector::get_debug_info (void)
{
...
void
Madara::Knowledge_Engine::Containers::String_Vector::modify_ (void)
{
  modify ();
}

std::string
Madara::Knowledge_Engine::Containers::String_Vector::get_debug_info_ (void)
{
  return get_debug_info ();
}

Madara::Knowledge_Engine::Containers::Base_Container *
Madara::Knowledge_Engine::Containers::String_Vector::clone (void) const
{
...
bool
Madara::Knowledge_Engine::Containers::String_Vector::is_true (void) const
{
  bool result (false);
...
bool
Madara::Knowledge_Engine::Containers::String_Vector::is_false (void) const
{
  return !is_true ();
}
...
bool
Madara::Knowledge_Engine::Containers::String_Vector::is_true_ (void) const
{
  return is_true ();
}

bool
Madara::Knowledge_Engine::Containers::String_Vector::is_false_ (void) const
{
  return is_false ();
}

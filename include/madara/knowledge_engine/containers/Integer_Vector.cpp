...
std::string
Madara::Knowledge_Engine::Containers::Integer_Vector::get_debug_info (void)
{
...
void
Madara::Knowledge_Engine::Containers::Integer_Vector::modify_ (void)
{
  modify ();
}

std::string
Madara::Knowledge_Engine::Containers::Integer_Vector::get_debug_info_ (void)
{
  return get_debug_info ();
}

Madara::Knowledge_Engine::Containers::Base_Container *
Madara::Knowledge_Engine::Containers::Integer_Vector::clone (void) const
{
...
void
Madara::Knowledge_Engine::Containers::Integer_Vector::push_back (type value)
{
  if (context_ && name_ != "")
  {
    Context_Guard context_guard (*context_);
...
void
Madara::Knowledge_Engine::Containers::Integer_Vector::set_delimiter (
const std::string & delimiter)
{
  delimiter_ = delimiter;
  if (context_)
...
std::string
Madara::Knowledge_Engine::Containers::Integer_Vector::get_delimiter (void)
{
  return delimiter_;
}
...
bool
Madara::Knowledge_Engine::Containers::Integer_Vector::is_true (void) const
{
  bool result (false);
...
bool
Madara::Knowledge_Engine::Containers::Integer_Vector::is_false (void) const
{
  return !is_true ();
}
...
bool
Madara::Knowledge_Engine::Containers::Integer_Vector::is_true_ (void) const
{
  return is_true ();
}

bool
Madara::Knowledge_Engine::Containers::Integer_Vector::is_false_ (void) const
{
  return is_false ();
}

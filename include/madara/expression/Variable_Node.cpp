...
madara::expression::Variable_Node::Variable_Node (
...
std::string
madara::expression::Variable_Node::expand_key (void) const
{
...
void
madara::expression::Variable_Node::accept (Visitor &visitor) const
{
  visitor.visit (*this);
}

madara::Knowledge_Record
madara::expression::Variable_Node::item () const
{
  if (record_)
    return *record_;
  else
...
madara::Knowledge_Record
madara::expression::Variable_Node::prune (bool & can_change)
{
...
madara::Knowledge_Record 
madara::expression::Variable_Node::evaluate (
...
const std::string &
madara::expression::Variable_Node::key () const
{
  return key_;
}

int
madara::expression::Variable_Node::set (
...
int
madara::expression::Variable_Node::set (const madara::Knowledge_Record::Integer & value,
  const madara::knowledge::Knowledge_Update_Settings & settings)
{
  if (record_)
  {
...
int
madara::expression::Variable_Node::set (double value,
  const madara::knowledge::Knowledge_Update_Settings & settings)
{
  if (record_)
  {
...
int
madara::expression::Variable_Node::set (const std::string & value,
  const madara::knowledge::Knowledge_Update_Settings & settings)
{
  if (record_)
  {
...
madara::Knowledge_Record 
madara::expression::Variable_Node::dec (
  const madara::knowledge::Knowledge_Update_Settings & settings)
{
  if (record_)
  {
...
madara::Knowledge_Record 
madara::expression::Variable_Node::inc (
  const madara::knowledge::Knowledge_Update_Settings & settings)
{
  if (record_)
  {

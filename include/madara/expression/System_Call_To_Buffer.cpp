...
madara::expression::System_Call_To_Buffer::System_Call_To_Buffer (
...
// Dtor
madara::expression::System_Call_To_Buffer::~System_Call_To_Buffer (void)
{
}

madara::Knowledge_Record
madara::expression::System_Call_To_Buffer::item (void) const
{
...
madara::Knowledge_Record
madara::expression::System_Call_To_Buffer::prune (bool & can_change)
{
...
madara::Knowledge_Record 
madara::expression::System_Call_To_Buffer::evaluate (
...
// accept a visitor
void 
madara::expression::System_Call_To_Buffer::accept (

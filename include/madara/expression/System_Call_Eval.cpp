...
madara::expression::System_Call_Eval::System_Call_Eval (
...
// Dtor
madara::expression::System_Call_Eval::~System_Call_Eval (void)
{
}

madara::Knowledge_Record
madara::expression::System_Call_Eval::item (void) const
{
...
madara::Knowledge_Record
madara::expression::System_Call_Eval::prune (bool & can_change)
{
...
madara::Knowledge_Record 
madara::expression::System_Call_Eval::evaluate (
...
// accept a visitor
void 
madara::expression::System_Call_Eval::accept (

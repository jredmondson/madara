#ifndef _MADARA_COMPOSITE_EQUALITY_NODE_H_
#define _MADARA_COMPOSITE_EQUALITY_NODE_H_
...
namespace madara
{
  namespace expression
  {
     ...
     *        for equality
     */
    class CompositeEqualityNode : public CompositeBinaryNode
    {
    public:
      /**
       * Constructor
       ...
       **/
      CompositeEqualityNode (logger::Logger & logger,
        ComponentNode *left,
        ComponentNode *right);
...
#endif // _MADARA_COMPOSITE_EQUALITY_NODE_H_

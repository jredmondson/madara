...
madara::knowledge::KnowledgeRecord madara::expression::CompositeOrNode::item(
    void) const
{
...
madara::knowledge::KnowledgeRecord madara::expression::CompositeOrNode::prune(
    bool& can_change)
{
...
// accept a visitor
void madara::expression::CompositeOrNode::accept(Visitor& visitor) const
{
  visitor.visit(*this);
}

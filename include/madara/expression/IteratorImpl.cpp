...
madara::expression::InOrderIteratorImpl::operator* (void)
{
  return stack_.top ();
}
...
bool 
madara::expression::InOrderIteratorImpl::operator== (
  const ExpressionTreeIteratorImpl &rhs) const
{
  const InOrderIteratorImpl * in_order_rhs = dynamic_cast
    <const InOrderIteratorImpl *> (&rhs);
  ...
  if (in_order_rhs)
    {
      ...
      ExpressionTree &t1 =
        const_cast <ExpressionTree &> (tree_);
      ExpressionTree &t2 =
        const_cast <ExpressionTree &> (in_order_rhs->tree_);
...
madara::expression::ExpressionTree 
madara::expression::PreOrderIteratorImpl::operator* (void)
{
  return stack_.top ();
}
...
bool 
madara::expression::PreOrderIteratorImpl::operator== (
  const ExpressionTreeIteratorImpl &rhs) const
{
  const PreOrderIteratorImpl *pre_order_rhs = dynamic_cast
    <const PreOrderIteratorImpl *> (&rhs);
  ...
  if (pre_order_rhs)
    {
      ...
      ExpressionTree &t2 = const_cast <ExpressionTree &> (
        pre_order_rhs->tree_);
...
madara::expression::ExpressionTree 
madara::expression::PostOrderIteratorImpl::operator* (void)
{
  return stack_.top ();
}
...
bool 
madara::expression::PostOrderIteratorImpl::operator== (
  const ExpressionTreeIteratorImpl &rhs) const
{
  const PostOrderIteratorImpl * post_order_rhs = dynamic_cast
    <const PostOrderIteratorImpl *> (&rhs);
...
madara::expression::LevelOrderExpressionTreeIteratorImpl::LevelOrderExpressionTreeIteratorImpl (
  const ExpressionTree &tree, bool end_iter)
  : ExpressionTreeIteratorImpl (tree), 
    queue_ (LQUEUE_SIZE)
{
...
madara::expression::ExpressionTreeIteratorImpl * 
madara::expression::LevelOrderExpressionTreeIteratorImpl::clone (
  void)
{

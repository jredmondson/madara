...
madara::knowledge::KnowledgeRecord madara::expression::SystemCallEval::item(
    void) const
{
...
madara::knowledge::KnowledgeRecord madara::expression::SystemCallEval::prune(
    bool& can_change)
{
...
madara::knowledge::KnowledgeRecord madara::expression::SystemCallEval::evaluate(
    const madara::knowledge::KnowledgeUpdateSettings& settings)
{
  ...
  if (nodes_.size() > 0) {
    ...
    madara::knowledge::CompiledExpression expression =
        context_.compile(nodes_[0]->evaluate(settings).to_string());
...
// accept a visitor
void madara::expression::SystemCallEval::accept(

...
madara::expression::SystemCallToHostDirs::SystemCallToHostDirs(
...
// Dtor
madara::expression::SystemCallToHostDirs::~SystemCallToHostDirs(void) {}
...
// accept a visitor
void madara::expression::SystemCallToHostDirs::accept(

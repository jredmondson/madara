...
madara::knowledge::KnowledgeRecord
madara::expression::SystemCallSin::prune (bool & can_change)
{
  ...
  else
  {
    madara_logger_ptr_log (logger_, logger::LOG_EMERGENCY,
      "KARL COMPILE ERROR: System call sin requires 1 argument,"
...
madara::knowledge::KnowledgeRecord 
madara::expression::SystemCallSin::evaluate (
...
// accept a visitor
void 
madara::expression::SystemCallSin::accept (

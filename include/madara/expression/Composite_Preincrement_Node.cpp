...
madara::expression::Composite_Preincrement_Node::Composite_Preincrement_Node (
...
// Dtor
madara::expression::Composite_Preincrement_Node::~Composite_Preincrement_Node (void)
{
}

madara::Knowledge_Record
madara::expression::Composite_Preincrement_Node::item (void) const
{
...
madara::Knowledge_Record
madara::expression::Composite_Preincrement_Node::prune (bool & can_change)
{
...
madara::Knowledge_Record 
madara::expression::Composite_Preincrement_Node::evaluate (
...
// accept a visitor
void 
madara::expression::Composite_Preincrement_Node::accept (Visitor &visitor) const
{
  visitor.visit (*this);
}

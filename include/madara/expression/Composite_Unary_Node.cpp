...
madara::expression::Composite_Unary_Node::Composite_Unary_Node (
...
// Dtor
madara::expression::Composite_Unary_Node::~Composite_Unary_Node (void)
{
  delete right_;
}
...
madara::expression::Composite_Unary_Node::right (void) const
{
  return right_;
}

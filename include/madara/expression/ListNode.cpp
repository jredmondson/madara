...
madara::knowledge::KnowledgeRecord madara::expression::ListNode::item() const
{
...
madara::knowledge::KnowledgeRecord madara::expression::ListNode::prune(
    bool& can_change)
{
...
madara::knowledge::KnowledgeRecord madara::expression::ListNode::evaluate(

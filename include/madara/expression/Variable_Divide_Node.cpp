...
madara::expression::Variable_Divide_Node::Variable_Divide_Node (
...
void
madara::expression::Variable_Divide_Node::accept (Visitor &visitor) const
{
  visitor.visit (*this);
}

madara::Knowledge_Record
madara::expression::Variable_Divide_Node::item () const
{
...
madara::Knowledge_Record
madara::expression::Variable_Divide_Node::prune (bool & can_change)
{
...
madara::Knowledge_Record 
madara::expression::Variable_Divide_Node::evaluate (

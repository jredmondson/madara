...
madara::knowledge::KnowledgeRecord madara::expression::SystemCallSetClock::item(
    void) const
{
    ...
    const madara::knowledge::KnowledgeUpdateSettings& settings)
{
  ...
  if (nodes_.size() == 1) {
    ...
    if (variable) {
      ...
      return madara::knowledge::KnowledgeRecord(variable->get_record()->clock);
    } else {
      madara_logger_ptr_log(logger_, logger::LOG_ERROR,
          "madara::expression::SystemCallSetClock: "
          "KARL RUNTIME ERROR:"
...
// accept a visitor
void madara::expression::SystemCallSetClock::accept(

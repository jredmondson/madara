...
madara::knowledge::KnowledgeRecord madara::expression::SystemCallCos::item(
    void) const
{
...
madara::knowledge::KnowledgeRecord madara::expression::SystemCallCos::prune(
    bool& can_change)
{
...
madara::knowledge::KnowledgeRecord madara::expression::SystemCallCos::evaluate(
...
// accept a visitor
void madara::expression::SystemCallCos::accept(

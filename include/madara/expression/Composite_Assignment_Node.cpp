...
madara::expression::Composite_Assignment_Node::Composite_Assignment_Node (
...
madara::expression::Composite_Assignment_Node::item (void) const
{
  return "=";
}
...
madara::Knowledge_Record
madara::expression::Composite_Assignment_Node::prune (bool & can_change)
{
...
madara::Knowledge_Record 
madara::expression::Composite_Assignment_Node::evaluate (
...
// accept a visitor
void 
madara::expression::Composite_Assignment_Node::accept (Visitor &visitor) const
{
  visitor.visit (*this);
}

...
madara::expression::Composite_Or_Node::Composite_Or_Node (
...
madara::expression::Composite_Or_Node::item (void) const
{
  return "||";
}
...
madara::Knowledge_Record
madara::expression::Composite_Or_Node::prune (bool & can_change)
{
...
madara::Knowledge_Record 
madara::expression::Composite_Or_Node::evaluate (
...
// accept a visitor
void 
madara::expression::Composite_Or_Node::accept (Visitor &visitor) const
{
  visitor.visit (*this);
}

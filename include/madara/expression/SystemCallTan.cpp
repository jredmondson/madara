...
madara::knowledge::KnowledgeRecord madara::expression::SystemCallTan::item(
    void) const
{
...
madara::knowledge::KnowledgeRecord madara::expression::SystemCallTan::prune(
    bool& can_change)
{
...
madara::knowledge::KnowledgeRecord madara::expression::SystemCallTan::evaluate(
...
// accept a visitor
void madara::expression::SystemCallTan::accept(

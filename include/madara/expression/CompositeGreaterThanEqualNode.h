#ifndef _MADARA_COMPOSITE_GREATER_THAN_EQUAL_NODE_H_
#define _MADARA_COMPOSITE_GREATER_THAN_EQUAL_NODE_H_
...
namespace madara
{
  namespace expression
  {
     ...
     */
    class CompositeGreaterThanEqualNode : public CompositeBinaryNode
    {
    public:
      /**
       * Constructor
       ...
       **/
      CompositeGreaterThanEqualNode (logger::Logger & logger,
        ComponentNode *left,
        ComponentNode *right);
...
#endif // _MADARA_COMPOSITE_GREATER_THAN_EQUAL_NODE_H_
...
madara::knowledge::KnowledgeRecord madara::expression::ComponentNode::item(
    void) const
{
...
madara::expression::ComponentNode* madara::expression::ComponentNode::left(
    void) const
{
  return 0;
}
...
madara::expression::ComponentNode* madara::expression::ComponentNode::right(
    void) const
{
  return 0;
}
...
// accept a visitor
void madara::expression::ComponentNode::accept(
    madara::expression::Visitor&) const
{
}

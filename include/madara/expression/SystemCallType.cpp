...
madara::expression::SystemCallType::item (void) const
{
...
madara::knowledge::KnowledgeRecord
madara::expression::SystemCallType::prune (bool & can_change)
{
...
madara::knowledge::KnowledgeRecord 
madara::expression::SystemCallType::evaluate (
...
// accept a visitor
void 
madara::expression::SystemCallType::accept (

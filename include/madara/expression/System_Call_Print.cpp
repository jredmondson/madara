...
madara::expression::System_Call_Print::System_Call_Print (
...
// Dtor
madara::expression::System_Call_Print::~System_Call_Print (void)
{
}

madara::Knowledge_Record
madara::expression::System_Call_Print::item (void) const
{
...
madara::Knowledge_Record
madara::expression::System_Call_Print::prune (bool & can_change)
{
...
madara::Knowledge_Record 
madara::expression::System_Call_Print::evaluate (
...
// accept a visitor
void 
madara::expression::System_Call_Print::accept (

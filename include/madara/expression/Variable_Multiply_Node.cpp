...
madara::expression::Variable_Multiply_Node::Variable_Multiply_Node (
...
void
madara::expression::Variable_Multiply_Node::accept (Visitor &visitor) const
{
  visitor.visit (*this);
}

madara::Knowledge_Record
madara::expression::Variable_Multiply_Node::item () const
{
...
madara::Knowledge_Record
madara::expression::Variable_Multiply_Node::prune (bool & can_change)
{
...
madara::Knowledge_Record 
madara::expression::Variable_Multiply_Node::evaluate (

...
madara::knowledge::KnowledgeRecord madara::expression::SystemCallSqrt::item(
    void) const
{
...
madara::knowledge::KnowledgeRecord madara::expression::SystemCallSqrt::prune(
    bool& can_change)
{
...
madara::knowledge::KnowledgeRecord madara::expression::SystemCallSqrt::evaluate(
...
// accept a visitor
void madara::expression::SystemCallSqrt::accept(

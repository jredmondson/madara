...
// Ctor
madara::expression::Composite_Inequality_Node::Composite_Inequality_Node (
...
madara::expression::Composite_Inequality_Node::item (void) const
{
...
madara::Knowledge_Record
madara::expression::Composite_Inequality_Node::prune (bool & can_change)
{
...
madara::Knowledge_Record 
madara::expression::Composite_Inequality_Node::evaluate (
...
// accept a visitor
void 
madara::expression::Composite_Inequality_Node::accept (Visitor &visitor) const
{
  visitor.visit (*this);
}

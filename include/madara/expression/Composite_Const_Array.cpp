...
madara::expression::Composite_Const_Array::Composite_Const_Array (
...
// Dtor
madara::expression::Composite_Const_Array::~Composite_Const_Array (void)
{
}

madara::Knowledge_Record
madara::expression::Composite_Const_Array::item (void) const
{
...
madara::Knowledge_Record
madara::expression::Composite_Const_Array::prune (bool & can_change)
{
  can_change = false;
...
madara::Knowledge_Record 
madara::expression::Composite_Const_Array::evaluate (
...
// accept a visitor
void 
madara::expression::Composite_Const_Array::accept (Visitor &visitor) const
{
  visitor.visit (*this);
}

...
madara::expression::System_Call_Write_File::System_Call_Write_File (
...
// Dtor
madara::expression::System_Call_Write_File::~System_Call_Write_File (void)
{
}

madara::Knowledge_Record
madara::expression::System_Call_Write_File::item (void) const
{
...
madara::Knowledge_Record
madara::expression::System_Call_Write_File::prune (bool & can_change)
{
...
madara::Knowledge_Record 
madara::expression::System_Call_Write_File::evaluate (
...
// accept a visitor
void 
madara::expression::System_Call_Write_File::accept (

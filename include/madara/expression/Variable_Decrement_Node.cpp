...
madara::expression::Variable_Decrement_Node::Variable_Decrement_Node (
...
void
madara::expression::Variable_Decrement_Node::accept (Visitor &visitor) const
{
  visitor.visit (*this);
}

madara::Knowledge_Record
madara::expression::Variable_Decrement_Node::item () const
{
...
madara::Knowledge_Record
madara::expression::Variable_Decrement_Node::prune (bool & can_change)
{
...
madara::Knowledge_Record 
madara::expression::Variable_Decrement_Node::evaluate (

...
madara::expression::Variable_Increment_Node::Variable_Increment_Node (
...
void
madara::expression::Variable_Increment_Node::accept (Visitor &visitor) const
{
  visitor.visit (*this);
}

madara::Knowledge_Record
madara::expression::Variable_Increment_Node::item () const
{
...
madara::Knowledge_Record
madara::expression::Variable_Increment_Node::prune (bool & can_change)
{
...
madara::Knowledge_Record 
madara::expression::Variable_Increment_Node::evaluate (

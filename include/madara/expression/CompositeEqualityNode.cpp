...
madara::expression::CompositeEqualityNode::CompositeEqualityNode (
...
madara::expression::CompositeEqualityNode::item (void) const
{
...
madara::knowledge::KnowledgeRecord
madara::expression::CompositeEqualityNode::prune (bool & can_change)
{
  ...
  else
  {
    ...
    throw exceptions::KarlException ("madara::expression::CompositeEqualityNode::"
      "KARL COMPILE ERROR: Equality has no left expression\n");
  }
...
madara::knowledge::KnowledgeRecord 
madara::expression::CompositeEqualityNode::evaluate (
...
// accept a visitor
void 
madara::expression::CompositeEqualityNode::accept (Visitor &visitor) const
{
  visitor.visit (*this);
}

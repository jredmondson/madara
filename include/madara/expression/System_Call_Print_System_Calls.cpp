...
madara::expression::System_Calls_Help
madara::expression::System_Call_Print_System_Calls::calls_;

madara::expression::System_Call_Print_System_Calls::System_Call_Print_System_Calls (
...
// Dtor
madara::expression::System_Call_Print_System_Calls::~System_Call_Print_System_Calls (void)
{
}

madara::Knowledge_Record
madara::expression::System_Call_Print_System_Calls::item (void) const
{
...
madara::Knowledge_Record
madara::expression::System_Call_Print_System_Calls::prune (bool & can_change)
{
...
madara::Knowledge_Record 
madara::expression::System_Call_Print_System_Calls::evaluate (
...
// accept a visitor
void 
madara::expression::System_Call_Print_System_Calls::accept (

...
namespace madara
{
  namespace expression
  {
    ...
    public:
      ...
      /// Equality operator.
      virtual bool operator== (const ExpressionTreeIteratorImpl &rhs)
        const = 0;
    ...
    public:
      ...
      InOrderIteratorImpl (const ExpressionTree &tree,
                                   bool end_iter = false);
      ...
      /// Nonequality operator.
      virtual bool operator!= (const ExpressionTreeIteratorImpl &lhs)
        const;
    ...
    public:
      ...
      /// is set to true, the iterator points to the end of the
      /// tree. Otherwise, the iterator starts with a free tree.
      PreOrderIteratorImpl (const ExpressionTree &tree, 
                                    bool end_iter = false);
    ...
    public:
      ...
      PostOrderIteratorImpl (const ExpressionTree &tree, 
                                     bool end_iter = false);
    ...
    public:
      ...
      LevelOrderExpressionTreeIteratorImpl (const ExpressionTree &tree,
                                                 bool end_iter = false);

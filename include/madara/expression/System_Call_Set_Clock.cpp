...
madara::expression::System_Call_Set_Clock::System_Call_Set_Clock (
...
// Dtor
madara::expression::System_Call_Set_Clock::~System_Call_Set_Clock (void)
{
}

madara::Knowledge_Record
madara::expression::System_Call_Set_Clock::item (void) const
{
...
madara::Knowledge_Record
madara::expression::System_Call_Set_Clock::prune (bool & can_change)
{
...
madara::Knowledge_Record 
madara::expression::System_Call_Set_Clock::evaluate (
...
// accept a visitor
void 
madara::expression::System_Call_Set_Clock::accept (

...
madara::expression::CompositeGreaterThanNode::CompositeGreaterThanNode (
...
madara::expression::CompositeGreaterThanNode::item (void) const
{
...
madara::knowledge::KnowledgeRecord
madara::expression::CompositeGreaterThanNode::prune (bool & can_change)
{
  ...
  else
  {
    ...
    throw exceptions::KarlException ("madara::expression::CompositeGreaterThanNode: "
      "KARL COMPILE ERROR: "
      "GreaterThan has no left expression\n"); 
  }
  ...
  else
  {
    ...
    throw exceptions::KarlException ("madara::expression::CompositeGreaterThanNode: "
      "KARL COMPILE ERROR: "
      "GreaterThan has no right expression\n"); 
  }
...
madara::knowledge::KnowledgeRecord 
madara::expression::CompositeGreaterThanNode::evaluate (
...
// accept a visitor
void 
madara::expression::CompositeGreaterThanNode::accept (Visitor &visitor) const
{
  visitor.visit (*this);
}

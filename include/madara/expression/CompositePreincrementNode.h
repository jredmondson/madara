/* -*- C++ -*- */
#ifndef _MADARA_COMPOSITE_PREINCREMENT_NODE_H_
#define _MADARA_COMPOSITE_PREINCREMENT_NODE_H_
...
namespace madara
{
  namespace expression
  {
     ...
     */
    class CompositePreincrementNode : public CompositeUnaryNode
    {
    public:
      /**
       * Constructor
       ...
       **/
      CompositePreincrementNode (logger::Logger & logger,
        ComponentNode *right);

      /**
       * Destructor
       **/
      virtual ~CompositePreincrementNode (void);
...
#endif /* _MADARA_COMPOSITE_PREINCREMENT_NODE_H_ */

...
madara::expression::Composite_Multiply_Node::Composite_Multiply_Node (
...
// Dtor
madara::expression::Composite_Multiply_Node::~Composite_Multiply_Node (void)
{
}

madara::Knowledge_Record
madara::expression::Composite_Multiply_Node::item (void) const
{
  return "*";
}
...
madara::Knowledge_Record
madara::expression::Composite_Multiply_Node::prune (bool & can_change)
{
...
madara::Knowledge_Record 
madara::expression::Composite_Multiply_Node::evaluate (
...
// accept a visitor
void 
madara::expression::Composite_Multiply_Node::accept (Visitor& visitor) const
{
  visitor.visit (*this);
}

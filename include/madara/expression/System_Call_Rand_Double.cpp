...
madara::expression::System_Call_Rand_Double::System_Call_Rand_Double (
...
// Dtor
madara::expression::System_Call_Rand_Double::~System_Call_Rand_Double (void)
{
}

madara::Knowledge_Record
madara::expression::System_Call_Rand_Double::item (void) const
{
...
madara::Knowledge_Record
madara::expression::System_Call_Rand_Double::prune (bool & can_change)
{
  can_change = true;
...
madara::Knowledge_Record 
madara::expression::System_Call_Rand_Double::evaluate (
...
// accept a visitor
void 
madara::expression::System_Call_Rand_Double::accept (

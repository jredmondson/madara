...
madara::expression::System_Call_Delete_Variable::System_Call_Delete_Variable (
...
// Dtor
madara::expression::System_Call_Delete_Variable::~System_Call_Delete_Variable (void)
{
}

madara::Knowledge_Record
madara::expression::System_Call_Delete_Variable::item (void) const
{
...
madara::Knowledge_Record
madara::expression::System_Call_Delete_Variable::prune (bool & can_change)
{
...
madara::Knowledge_Record 
madara::expression::System_Call_Delete_Variable::evaluate (
...
// accept a visitor
void 
madara::expression::System_Call_Delete_Variable::accept (

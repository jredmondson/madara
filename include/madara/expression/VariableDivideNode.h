/* -*- C++ -*- */
#ifndef _MADARA_VARIABLE_DIVIDE_NODE_H_
#define _MADARA_VARIABLE_DIVIDE_NODE_H_
...
namespace madara
{
  namespace expression
  {
    ...
    class VariableDivideNode : public ComponentNode
    {
    public:
      /// Ctor.
      VariableDivideNode (ComponentNode * lhs,
...
#endif /* _MADARA_VARIABLE_DIVIDE_NODE_H_ */

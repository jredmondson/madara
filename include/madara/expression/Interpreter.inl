...
inline bool madara::expression::Interpreter::is_operator(char input)
{
...
inline bool madara::expression::Interpreter::is_number(char input)
{
  return input >= '0' && input <= '9';
}

// method for checking if a character is a number
inline bool madara::expression::Interpreter::is_exponential(char input)
{
  return input == 'e' || input == 'E' || input == '-' ||
         (input >= '0' && input <= '9');
}

inline bool madara::expression::Interpreter::is_reserved_word(
    const std::string& input)
{
  return input == "true" || input == "false" || input == "nan" ||
         input == "inf";
}

// method for checking if a character is a number
inline bool madara::expression::Interpreter::is_string_literal(char input)
{
  return input == '"' || input == '\'';
}
...
inline bool madara::expression::Interpreter::is_alphanumeric(char input)
{
  return (input >= 'a' && input <= 'z') || (input >= 'A' && input <= 'Z') ||
         (input == '_') || (input >= '0' && input <= '9') || input == '.' ||
         input == '{' || input == '}';
}

// method for checking if input is whitespace
inline bool madara::expression::Interpreter::is_whitespace(char input)
{
 ...
 **/
inline bool madara::expression::Interpreter::delete_expression(

...
madara::expression::Composite_Postdecrement_Node::Composite_Postdecrement_Node (
...
// Dtor
madara::expression::Composite_Postdecrement_Node::~Composite_Postdecrement_Node (void)
{
}

madara::Knowledge_Record
madara::expression::Composite_Postdecrement_Node::item (void) const
{
...
madara::Knowledge_Record
madara::expression::Composite_Postdecrement_Node::prune (bool & can_change)
{
...
madara::Knowledge_Record 
madara::expression::Composite_Postdecrement_Node::evaluate (
...
// accept a visitor
void 
madara::expression::Composite_Postdecrement_Node::accept (Visitor &visitor) const
{
  visitor.visit (*this);
}

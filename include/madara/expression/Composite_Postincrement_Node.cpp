...
madara::expression::Composite_Postincrement_Node::Composite_Postincrement_Node (
...
// Dtor
madara::expression::Composite_Postincrement_Node::~Composite_Postincrement_Node (void)
{
}

madara::Knowledge_Record
madara::expression::Composite_Postincrement_Node::item (void) const
{
...
madara::Knowledge_Record
madara::expression::Composite_Postincrement_Node::prune (bool & can_change)
{
...
madara::Knowledge_Record 
madara::expression::Composite_Postincrement_Node::evaluate (
...
// accept a visitor
void 
madara::expression::Composite_Postincrement_Node::accept (Visitor &visitor) const
{
  visitor.visit (*this);
}

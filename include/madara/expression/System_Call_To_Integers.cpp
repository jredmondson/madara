...
madara::expression::System_Call_To_Integers::System_Call_To_Integers (
...
// Dtor
madara::expression::System_Call_To_Integers::~System_Call_To_Integers (void)
{
}

madara::Knowledge_Record
madara::expression::System_Call_To_Integers::item (void) const
{
...
madara::Knowledge_Record
madara::expression::System_Call_To_Integers::prune (bool & can_change)
{
...
madara::Knowledge_Record 
madara::expression::System_Call_To_Integers::evaluate (
...
// accept a visitor
void 
madara::expression::System_Call_To_Integers::accept (

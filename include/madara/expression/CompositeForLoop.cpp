...
madara::expression::CompositeForLoop::CompositeForLoop(
    ComponentNode* precondition, ComponentNode* condition,
    ComponentNode* postcondition, ComponentNode* body,
...
madara::knowledge::KnowledgeRecord madara::expression::CompositeForLoop::item(
    void) const
{
...
madara::knowledge::KnowledgeRecord madara::expression::CompositeForLoop::prune(
    bool& can_change)
{

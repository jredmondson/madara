...
madara::expression::Composite_Greater_Than_Equal_Node::Composite_Greater_Than_Equal_Node (
...
madara::expression::Composite_Greater_Than_Equal_Node::item (void) const
{
...
madara::Knowledge_Record
madara::expression::Composite_Greater_Than_Equal_Node::prune (bool & can_change)
{
...
madara::Knowledge_Record 
madara::expression::Composite_Greater_Than_Equal_Node::evaluate (
...
// accept a visitor
void 
madara::expression::Composite_Greater_Than_Equal_Node::accept (Visitor &visitor) const
{
  visitor.visit (*this);
}

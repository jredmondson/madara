...
madara::expression::List_Node::List_Node (
...
void
madara::expression::List_Node::accept (Visitor &visitor) const
{
  visitor.visit (*this);
}

madara::Knowledge_Record
madara::expression::List_Node::item () const
{
...
madara::Knowledge_Record
madara::expression::List_Node::prune (bool & can_change)
{
...
madara::Knowledge_Record 
madara::expression::List_Node::evaluate (

...
madara::expression::Composite_Greater_Than_Node::Composite_Greater_Than_Node (
...
madara::expression::Composite_Greater_Than_Node::item (void) const
{
...
madara::Knowledge_Record
madara::expression::Composite_Greater_Than_Node::prune (bool & can_change)
{
...
madara::Knowledge_Record 
madara::expression::Composite_Greater_Than_Node::evaluate (
...
// accept a visitor
void 
madara::expression::Composite_Greater_Than_Node::accept (Visitor &visitor) const
{
  visitor.visit (*this);
}

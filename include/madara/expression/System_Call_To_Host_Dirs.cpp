...
madara::expression::System_Call_To_Host_Dirs::System_Call_To_Host_Dirs (
...
// Dtor
madara::expression::System_Call_To_Host_Dirs::~System_Call_To_Host_Dirs (void)
{
}

madara::Knowledge_Record
madara::expression::System_Call_To_Host_Dirs::item (void) const
{
...
madara::Knowledge_Record
madara::expression::System_Call_To_Host_Dirs::prune (bool & can_change)
{
...
madara::Knowledge_Record 
madara::expression::System_Call_To_Host_Dirs::evaluate (
...
// accept a visitor
void 
madara::expression::System_Call_To_Host_Dirs::accept (

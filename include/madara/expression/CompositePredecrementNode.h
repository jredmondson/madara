/* -*- C++ -*- */
#ifndef _MADARA_COMPOSITE_PREDECREMENT_NODE_H_
#define _MADARA_COMPOSITE_PREDECREMENT_NODE_H_
...
namespace madara
{
  namespace expression
  {
     ...
     */
    class CompositePredecrementNode : public CompositeUnaryNode
    {
    public:
      /**
       * Constructor
       ...
       **/
      CompositePredecrementNode (logger::Logger & logger,
        ComponentNode *right);
...
#endif /* _MADARA_COMPOSITE_PREDECREMENT_NODE_H_ */

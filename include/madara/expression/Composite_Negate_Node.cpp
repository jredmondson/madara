...
madara::expression::Composite_Negate_Node::Composite_Negate_Node (
...
// Dtor
madara::expression::Composite_Negate_Node::~Composite_Negate_Node (void)
{
}

madara::Knowledge_Record
madara::expression::Composite_Negate_Node::item (void) const
{
  return "-";
}
...
madara::Knowledge_Record
madara::expression::Composite_Negate_Node::prune (bool & can_change)
{
...
madara::Knowledge_Record 
madara::expression::Composite_Negate_Node::evaluate (
...
// accept a visitor
void 
madara::expression::Composite_Negate_Node::accept (Visitor &visitor) const
{
  visitor.visit (*this);
}

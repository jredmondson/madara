...
madara::expression::Composite_Sequential_Node::Composite_Sequential_Node (
...
madara::expression::Composite_Sequential_Node::item (void) const
{
  return ",";
}
...
madara::Knowledge_Record
madara::expression::Composite_Sequential_Node::prune (bool & can_change)
{
...
madara::Knowledge_Record 
madara::expression::Composite_Sequential_Node::evaluate (
...
// accept a visitor
void 
madara::expression::Composite_Sequential_Node::accept (Visitor &visitor) const
{
  visitor.visit (*this);
}

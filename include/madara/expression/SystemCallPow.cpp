...
madara::knowledge::KnowledgeRecord madara::expression::SystemCallPow::item(
    void) const
{
...
madara::knowledge::KnowledgeRecord madara::expression::SystemCallPow::prune(
    bool& can_change)
{
...
madara::knowledge::KnowledgeRecord madara::expression::SystemCallPow::evaluate(
...
// accept a visitor
void madara::expression::SystemCallPow::accept(

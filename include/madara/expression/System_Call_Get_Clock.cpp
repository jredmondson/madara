...
madara::expression::System_Call_Get_Clock::System_Call_Get_Clock (
...
// Dtor
madara::expression::System_Call_Get_Clock::~System_Call_Get_Clock (void)
{
}

madara::Knowledge_Record
madara::expression::System_Call_Get_Clock::item (void) const
{
...
madara::Knowledge_Record
madara::expression::System_Call_Get_Clock::prune (bool & can_change)
{
...
madara::Knowledge_Record 
madara::expression::System_Call_Get_Clock::evaluate (
...
// accept a visitor
void 
madara::expression::System_Call_Get_Clock::accept (

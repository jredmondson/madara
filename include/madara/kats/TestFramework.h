...
namespace madara
{
  ...
  namespace kats
  {
    class KATSExport Settings : public madara::transport::Settings
    {
    public:
     ...
     */
    class KATSExport TestFramework
    {
    public:
      /**
       * Constructor
       ...
       **/
      TestFramework (const Settings & config);

      /**
       * Copy constructor
       **/
      TestFramework (const TestFramework & original);
       ...
       */
      madara::KnowledgeRecord::Integer barrier (const std::string & event_name);
       ...
       **/
      madara::KnowledgeRecord::Integer get (const ::std::string & key);
      ...
      int set (const ::std::string & key,
        madara::KnowledgeRecord::Integer value = 1);

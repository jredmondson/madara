...
void
madara::transport::QoSTransportSettings::set_rebroadcast_ttl (unsigned char ttl)
{
  rebroadcast_ttl_ = ttl;
}

unsigned char
madara::transport::QoSTransportSettings::get_rebroadcast_ttl (void) const
{
...
unsigned char
madara::transport::QoSTransportSettings::get_participant_ttl (void) const
{
  return participant_rebroadcast_ttl_;
}

void
madara::transport::QoSTransportSettings::add_trusted_peer (
...
void
madara::transport::QoSTransportSettings::add_banned_peer (
  const std::string & peer)
{
...
bool
madara::transport::QoSTransportSettings::remove_trusted_peer (
  const std::string & peer)
{
...
bool
madara::transport::QoSTransportSettings::remove_banned_peer (
  const std::string & peer)
{
  bool condition = false;
...
bool
madara::transport::QoSTransportSettings::is_trusted (
...
void
madara::transport::QoSTransportSettings::attach (
...
void
madara::transport::QoSTransportSettings::clear_send_filters (uint32_t types)
{
...
void
madara::transport::QoSTransportSettings::clear_receive_filters (uint32_t types)
{
...
void
madara::transport::QoSTransportSettings::clear_rebroadcast_filters (uint32_t types)
{
...
void
madara::transport::QoSTransportSettings::clear_buffer_filters (void)
{
...
size_t
madara::transport::QoSTransportSettings::get_number_of_buffer_filters (
void) const
{
...
double
madara::transport::QoSTransportSettings::get_drop_rate (void) const
{
  return packet_drop_rate_;
}

int
madara::transport::QoSTransportSettings::get_drop_type (void) const
{
  return packet_drop_type_;
}

uint64_t
madara::transport::QoSTransportSettings::get_drop_burst (void) const
{
...
void
madara::transport::QoSTransportSettings::load_text (const std::string & filename,
  const std::string & prefix)
{
...
void
madara::transport::QoSTransportSettings::save_text (
  const std::string & filename,
  const std::string & prefix) const
{
  // Save the underlying base settings first

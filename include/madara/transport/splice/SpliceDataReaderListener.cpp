...
void madara::transport::SpliceDataReaderListener::on_sample_lost(
    DDS::DataReader_ptr, const DDS::SampleLostStatus& status)
{
}

void madara::transport::SpliceDataReaderListener::on_sample_rejected(
    DDS::DataReader_ptr, const DDS::SampleRejectedStatus& status)
{
}

void madara::transport::SpliceDataReaderListener::on_requested_incompatible_qos(
    DDS::DataReader_ptr, const DDS::RequestedIncompatibleQosStatus& status)
{
}

void madara::transport::SpliceDataReaderListener::on_requested_deadline_missed(
    DDS::DataReader_ptr reader,
    const DDS::RequestedDeadlineMissedStatus& status)
{
}

void madara::transport::SpliceDataReaderListener::on_liveliness_changed(
    DDS::DataReader_ptr reader, const DDS::LivelinessChangedStatus& status)
{
}

void madara::transport::SpliceDataReaderListener::on_subscription_matched(
    DDS::DataReader_ptr reader, const DDS::SubscriptionMatchedStatus& status)
{
  context_.set_changed();
}

void madara::transport::SpliceDataReaderListener::on_data_available(
    DDS::DataReader_ptr reader)
{
    ...
    for (int i = 0; i < amount; ++i)
    {
      ...
      if (madara::knowledge::ASSIGNMENT == update_data_list_[i].type)
      {
        madara_logger_log(context_->get_logger(), logger::LOG_MINOR,
            ...
            update_data_list_[i].originator.val(), update_data_list_[i].clock,

#if 0 //ndef _MADARA_UDP_REGISTRY_SERVER_READ_THREAD_H_
#define _MADARA_UDP_REGISTRY_SERVER_READ_THREAD_H_
...
namespace madara
{
  namespace transport
  {
     ...
     * @brief Thread for reading registry updates through a UDP socket
     **/
    class UdpRegistryServerReadThread : public threads::BaseThread
    {
    public:
      /**
       * Constructor
...
#endif // _MADARA_UDP_REGISTRY_SERVER_READ_THREAD_H_

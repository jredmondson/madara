...
madara::transport::UdpRegistryServerReadThread::UdpRegistryServerReadThread (
...
void
madara::transport::UdpRegistryServerReadThread::init (
  ...
  if (context_)
  {
    ...
    if (settings_.on_data_received_logic.length () != 0)
    {
      ...
      madara_logger_log (context_->get_logger (), logger::LOG_MAJOR,
        "UdpRegistryServerReadThread::init:" \
        " setting rules to %s\n",
...
void
madara::transport::UdpRegistryServerReadThread::rebroadcast (
...
void
madara::transport::UdpRegistryServerReadThread::cleanup (void)
{
}


void
madara::transport::UdpRegistryServerReadThread::run (void)
{

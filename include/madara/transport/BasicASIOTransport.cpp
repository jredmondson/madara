...
int
BasicASIOTransport::setup_socket (udp::socket &socket)
{
...
int
BasicASIOTransport::setup_sockets (void)
{
...
int
BasicASIOTransport::setup_read_threads ()
{

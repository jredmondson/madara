...
const char* operation_types[] = {"IDLE_OPERATION", "SENDING_OPERATION",
    "RECEIVING_OPERATION", "REBROADCASTING_OPERATION"};

madara::knowledge::KnowledgeRecord madara::filters::discard(
    knowledge::FunctionArguments& /*args*/, knowledge::Variables& /*vars*/)
{
  // this works because a default record is UNCREATED
  return madara::knowledge::KnowledgeRecord();
}

madara::knowledge::KnowledgeRecord madara::filters::discard_nonprimitives(
    knowledge::FunctionArguments& args, knowledge::Variables& /*vars*/)
{
...
madara::knowledge::KnowledgeRecord madara::filters::discard_nonfiles(
    knowledge::FunctionArguments& args, knowledge::Variables& /*vars*/)
{
  madara::knowledge::KnowledgeRecord result;
...
madara::knowledge::KnowledgeRecord madara::filters::log_args(
    knowledge::FunctionArguments& args, knowledge::Variables& vars)
{
  madara::knowledge::KnowledgeRecord result;

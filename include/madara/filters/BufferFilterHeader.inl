...
inline void
BufferFilterHeader::read (filters::BufferFilter * filter)
{
  if (filter != 0)
  {
...
inline const char * 
BufferFilterHeader::read (const char * buffer, int64_t & buffer_remaining)
{
...
inline char *
BufferFilterHeader::write (char * buffer, int64_t & buffer_remaining)
{
  if (buffer_remaining >= 20)
  {

...
void
madara::filters::EndpointClear::filter (
  ...
  knowledge::Variables & vars)
{
  ...
  madara_logger_log (vars.get_context ()->get_logger (),
    ...
    transport_context.get_originator ().c_str (),
    (int)records.size ());
...
void
madara::filters::EndpointClear::add_trusted_originator (
...
void
madara::filters::EndpointClear::clear_trusted_originators (void)
{
  trusted_originators_.clear ();
}

void
madara::filters::EndpointClear::set_prefix (const std::string & prefix)
{
  prefix_ = prefix;
}

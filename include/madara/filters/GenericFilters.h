 ...
 **/
MADARA_EXPORT knowledge::KnowledgeRecord discard(
 ...
 **/
MADARA_EXPORT knowledge::KnowledgeRecord discard_nonprimitives(
    knowledge::FunctionArguments& args, knowledge::Variables& vars);
 ...
 **/
MADARA_EXPORT knowledge::KnowledgeRecord discard_nonfiles(
    knowledge::FunctionArguments& args, knowledge::Variables& vars);
 ...
 * @return  record with status set to UNCREATED if arg is non-file
 **/
MADARA_EXPORT knowledge::KnowledgeRecord log_args(
    knowledge::FunctionArguments& args, knowledge::Variables& vars);
 ...
 * @param   vars              variable context
 **/
MADARA_EXPORT void log_aggregate(knowledge::KnowledgeMap& records,

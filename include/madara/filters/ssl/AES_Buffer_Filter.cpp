...
int Madara::Filters::AES_Buffer_Filter::generate_key (
...
int
Madara::Filters::AES_Buffer_Filter::encode (
...
int
Madara::Filters::AES_Buffer_Filter::decode (
  unsigned char * source, int size, int max_size) const
{
  int result_length (0);

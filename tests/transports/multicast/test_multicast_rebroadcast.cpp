...
madara::knowledge::KnowledgeRecord alter_rebroadcast(
...
int main(int argc, char** argv)
{
  ...
  settings.add_receive_filter(
      madara::knowledge::KnowledgeRecord::DOUBLE, madara::filters::discard);
  settings.enable_participant_ttl(2);
  settings.set_rebroadcast_ttl(2);
  settings.add_rebroadcast_filter(
      madara::knowledge::KnowledgeRecord::INTEGER, alter_rebroadcast);

...
int main(int argc, char** argv)
{
  ...
  madara_logger_ptr_log(
      logger::global_logger.get(), logger::LOG_ALWAYS, "MGT: %MGT\n");

  madara_logger_ptr_log(
      logger::global_logger.get(), logger::LOG_ALWAYS, "MTN: %MTN\n");

  madara_logger_ptr_log(
      logger::global_logger.get(), logger::LOG_ALWAYS, "MTZ: %MTZ\n");
  // create a counter

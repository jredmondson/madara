...
void test_probablistic(void)
{
  ...
  settings.update_drop_rate(.1, madara::transport::PACKET_DROP_PROBABLISTIC, 5);
  ...
  madara_logger_ptr_log(
      logger::global_logger.get(), logger::LOG_ALWAYS, "  Results were ");
  ...
  settings.update_drop_rate(.4, madara::transport::PACKET_DROP_PROBABLISTIC, 3);
  ...
  settings.update_drop_rate(.5, madara::transport::PACKET_DROP_PROBABLISTIC, 5);
  ...
  settings.update_drop_rate(.8, madara::transport::PACKET_DROP_PROBABLISTIC, 1);
...
void test_deterministic(void)
{
  ...
  settings.update_drop_rate(
      .1, madara::transport::PACKET_DROP_DETERMINISTIC, 6);
  ...
  settings.update_drop_rate(
      .3, madara::transport::PACKET_DROP_DETERMINISTIC, 1);
  ...
  settings.update_drop_rate(.4, madara::transport::PACKET_DROP_DETERMINISTIC);
  ...
  settings.update_drop_rate(
      .4, madara::transport::PACKET_DROP_DETERMINISTIC, 3);
  ...
  settings.update_drop_rate(
      .5, madara::transport::PACKET_DROP_DETERMINISTIC, 3);
  ...
  madara_logger_ptr_log(logger::global_logger.get(), logger::LOG_ALWAYS,
      "*****************BEGIN DETERMINISTIC 50%%, "
      "BURST=10******************\n");

  settings.update_drop_rate(
      .5, madara::transport::PACKET_DROP_DETERMINISTIC, 10);
  ...
  settings.update_drop_rate(
      .8, madara::transport::PACKET_DROP_DETERMINISTIC, 1);

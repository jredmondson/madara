...
jlong JNICALL Java_ai_madara_filters_EndpointClear_jni_1EndpointClear(
    JNIEnv*, jobject)
{
  return (jlong) new EndpointClear();
}

void JNICALL Java_ai_madara_filters_EndpointClear_jni_1addReceiveFilterTo(
...
void JNICALL Java_ai_madara_filters_EndpointClear_jni_1addSendFilterTo(
    JNIEnv* env, jobject, jlong cptr, jlong qosCptr)
{
  EndpointClear* current = (EndpointClear*)cptr;
  QoSTransportSettings* settings = (QoSTransportSettings*)qosCptr;
...
void JNICALL Java_ai_madara_filters_EndpointClear_jni_1addRebroadcastFilterTo(
    JNIEnv* env, jobject, jlong cptr, jlong qosCptr)
{
  EndpointClear* current = (EndpointClear*)cptr;
  QoSTransportSettings* settings = (QoSTransportSettings*)qosCptr;
 ...
 */
void JNICALL Java_ai_madara_filters_EndpointClear_jni_1setPrefix(
 ...
 * Signature: (J)V
 */
void JNICALL Java_ai_madara_filters_EndpointClear_jni_1freeEndpointClear(

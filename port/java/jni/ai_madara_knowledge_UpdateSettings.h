...
/* Header for class ai_madara_knowledge_UpdateSettings */

#ifndef _Included_ai_madara_knowledge_UpdateSettings
#define _Included_ai_madara_knowledge_UpdateSettings
#ifdef __cplusplus
extern "C" {
#endif
/*

  ...
  namespace utility
  {
    namespace java
    {
      ...
      inline void anyref_out(JNIEnv *env, knowledge::AnyRef ref, jlongArray out)
      {
        ...
        std::array<jlong, 2> arr{{
          reinterpret_cast<jlong>(ptrs.first),
      ...
      public:
        JavaUTFString(JNIEnv *env, jstring str)
          : env_(env), str_(str),
            chars_(env->GetStringUTFChars(str_, nullptr)) {}
      ...
      public:
        ...
        const jlong *data() const { return data_; }
      ...
      public:
        ...
        const jdouble *data() const { return data_; }

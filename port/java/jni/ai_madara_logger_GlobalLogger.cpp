#include "ai_madara_logger_GlobalLogger.h"
#include "madara/logger/GlobalLogger.h"

namespace logger = madara::logger;

jlong JNICALL Java_ai_madara_logger_GlobalLogger_jni_1getCPtr(JNIEnv*, jclass)
{
  return (jlong)logger::global_logger.get();
}

void JNICALL Java_ai_madara_logger_GlobalLogger_jni_1setLevel(
    JNIEnv*, jclass, jint level)
{
  logger::global_logger->set_level((int)level);
}

jint JNICALL Java_ai_madara_logger_GlobalLogger_jni_1getLevel(JNIEnv*, jclass)
{
  return (jint)logger::global_logger->get_level();
}

jstring JNICALL Java_ai_madara_logger_GlobalLogger_jni_1getTag(
    JNIEnv* env, jclass)
{
  return env->NewStringUTF(logger::global_logger->get_tag().c_str());
}

void JNICALL Java_ai_madara_logger_GlobalLogger_jni_1setTag(
...
void JNICALL Java_ai_madara_logger_GlobalLogger_jni_1addTerm(JNIEnv*, jclass)
{
  logger::global_logger->add_term();
}

void JNICALL Java_ai_madara_logger_GlobalLogger_jni_1addSyslog(JNIEnv*, jclass)
{
  logger::global_logger->add_syslog();
}

void JNICALL Java_ai_madara_logger_GlobalLogger_jni_1clear(JNIEnv*, jclass)
{
  logger::global_logger->clear();
}

void JNICALL Java_ai_madara_logger_GlobalLogger_jni_1addFile(
...
void JNICALL Java_ai_madara_logger_GlobalLogger_jni_1log(
...
void JNICALL Java_ai_madara_logger_GlobalLogger_jni_1setTimestampFormat(

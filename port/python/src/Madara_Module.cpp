...
void define_transport (void)
{
  ...
  // the types of packet drop policies for QoS_Transport_Settings class
  enum_<madara::transport::Packet_Drop_Type>("DropTypes")
...
/*
  ...
  class_<madara::knowledge::Knowledge_Reference_Settings> (
      "KnowledgeReferenceSettings",
      "Settings for referencing knowledge records", init<> ())
        
    .def (init <bool> ())
    .def (init <
      const madara::knowledge::Knowledge_Reference_Settings &> ())

    // define readwrite variables within the class
    .def_readwrite ("expand_variables",
      &madara::knowledge::Knowledge_Reference_Settings::expand_variables,
      "Always attempt to expand variable names")
    .def_readwrite ("never_exit",
      &madara::knowledge::Knowledge_Reference_Settings::never_exit,
  ...
  class_<madara::knowledge::Knowledge_Update_Settings,
          bases<madara::knowledge::Knowledge_Reference_Settings> > (
            "KnowledgeUpdateSettings",
            "Settings for updating knowledge records", init <> ())
    
    // other constructors here
    .def (init <
      const madara::knowledge::Knowledge_Update_Settings &> ())

    // define readwrite variables within the class
    .def_readwrite ("treat_globals_as_locals",
      	&madara::knowledge::Knowledge_Update_Settings::treat_globals_as_locals,
        "Treat global variable changes as if they were local variables")
    .def_readwrite ("signal_changes",
      	&madara::knowledge::Knowledge_Update_Settings::signal_changes,
        "Always signal on mutation (useful for multi-threaded applications)")
    .def_readwrite ("always_overwrite",
      	&madara::knowledge::Knowledge_Update_Settings::always_overwrite,
        "Always overwrite records, regardless of quality or consistency checks")
    .def_readwrite ("track_local_changes",
      	&madara::knowledge::Knowledge_Update_Settings::track_local_changes,
        "Track local changes for checkpointing purposes")
    .def_readwrite ("clock_increment",
      	&madara::knowledge::Knowledge_Update_Settings::clock_increment,
  ...
  class_<madara::knowledge::Wait_Settings,
          bases<madara::knowledge::Eval_Settings> > ("WaitSettings",
          "Settings for wait calls", init <> ())
    
    // other constructors here
    .def (init <
      const madara::knowledge::Wait_Settings &> ())
        
    // define readwrite variables within the class
    .def_readwrite ("poll_frequency",
      	&madara::knowledge::Wait_Settings::poll_frequency,
        "Frequency, in seconds, to evaluate the expression")
    .def_readwrite ("max_wait_time",
      	&madara::knowledge::Wait_Settings::max_wait_time,
  ...
  class_<madara::knowledge::Variables> ("Variables", init <> ())
    ...
    .def( "evaluate",
      static_cast<
        madara::Knowledge_Record (madara::knowledge::Variables::*)(
          const std::string &,
          const madara::knowledge::Knowledge_Update_Settings &)
  ...
  class_ <std::vector <madara::knowledge::Function_Arguments> > (
  ...
  class_<madara::knowledge::Knowledge_Base> ("KnowledgeBase",
    ...
    // define constructors
    .def (init <const madara::knowledge::Knowledge_Base &> ())

    // defines a python function
    .def( "define_function",
      static_cast<
        void (madara::knowledge::Knowledge_Base::*)(
          const std::string &,
          object)
    ...
    .def( "evaluate",
      static_cast<
        madara::Knowledge_Record (madara::knowledge::Knowledge_Base::*)(
          const std::string &, const madara::knowledge::Eval_Settings &)
    ...
    .def ("lock",
      &madara::knowledge::Knowledge_Base::lock,
      "Locks the knowledge base from updates from other threads")
    ...
    .def( "send_modifieds",
      static_cast<
        int (madara::knowledge::Knowledge_Base::*)(
          const std::string &,
          const madara::knowledge::Eval_Settings &)
    ...
    .def ("unlock",
      &madara::knowledge::Knowledge_Base::unlock,
    ...
    .def( "wait",
      static_cast<
        madara::Knowledge_Record (madara::knowledge::Knowledge_Base::*)(
          const std::string &, const madara::knowledge::Wait_Settings &)

...
/*
Since we want to work with sockets, we'll need a SOCKAcceptor to allow the
clients to connect to us.
*/
#include "ace/SOCK_Acceptor.h"

/*
The ClientHandler object we develop will be used to handle clients once
...
connection attempts and create ClientHandler objects when they happen. In
...
*/
typedef ACE_Acceptor < ClientHandler, ACE_SOCK_ACCEPTOR > ClientAcceptorBase;
...
providing a choice of concurrency strategies, we also maintain a ThreadPool
...
*/
class ClientAcceptor : public ClientAcceptorBase
  {
  public:
    typedef ClientAcceptorBase inherited;
    ...
    */
    ClientAcceptor(Madara::AgentContext & context, 
      int _concurrency = thread_pool_ );
    ...
    */
    int open( const ACE_INET_Addr & _addr, ACE_Reactor * _reactor,
      int _pool_size = ThreadPool::default_pool_size_ );
    ...
    */
    ...
    /*
    Give back a pointer to our thread pool.  Our ClientHandler objects
    ...
    */
    ...
    /*
    Since we can be constructed with a ThreadPool reference, there are times
    ...
    */
    ...
    // ClientHandler needs to update the context on handle_input
    Madara::AgentContext & context ()
      {
        return context_;
      }
  ...
  protected:
    ...
    ThreadPool   private_thread_pool_;

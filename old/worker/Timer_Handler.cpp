...
Timeout_Handler::Timeout_Handler (Madara::Agent_Context & context)
: context_ (context)
{
...
int 
Timeout_Handler::send_ping (const std::string & key)
{
  // necessary variables
...
int 
Timeout_Handler::check_key (const std::string &key)
{
  std::string this_key;
...
int 
Timeout_Handler::random_discover (void)
{
...
int 
Timeout_Handler::random_ping (void)
{
  int num_keys = context_.getNumKeys ();
...
int 
Timeout_Handler::handle_timeout (const ACE_Time_Value &tv, const void *arg)
{
